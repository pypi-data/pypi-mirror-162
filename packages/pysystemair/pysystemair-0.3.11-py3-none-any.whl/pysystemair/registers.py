...
registers = Box({
    ...
    ,"target_co2_ppm"                  : InputRegister(addr=1020)  # REG_DEMC_CO2_PI_SP: Set point for CO2 demand control
    ...
    ,"co2_sensor"                  : HoldingRegister(addr=12114) # REG_SENSOR_CO2S: CO2 value (accessory)
