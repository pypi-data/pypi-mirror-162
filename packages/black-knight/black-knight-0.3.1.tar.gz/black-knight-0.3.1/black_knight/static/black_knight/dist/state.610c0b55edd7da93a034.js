        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                if (axios_1.default.isAxiosError(error_1)) {
                    if (error_1.response) {
                        return [2, __assign({ ok: false }, error_1.response.data)];
                    }
                    else {
                        return [2, { ok: false, code: 400, message: error_1.message }];
                    }
                }
...
//# sourceMappingURL=source_maps/state.610c0b55edd7da93a034.js.map