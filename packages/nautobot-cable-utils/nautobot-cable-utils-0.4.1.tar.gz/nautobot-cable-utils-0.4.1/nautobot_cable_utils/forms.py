...
class CableTemplateFilterForm(BootstrapMixin, forms.Form):
    ...
    owner = ModelChoiceField(queryset=Tenant.objects.all(), to_field_name="slug", required=False)
    plug = ModelChoiceField(queryset=CablePlug.objects.all(), to_field_name="name", required=False)
...
class CableTemplateCSVForm(CSVModelForm):
    ...
    owner = CSVModelChoiceField(queryset=Tenant.objects.all(), required=False, to_field_name="name", help_text="Assigned Owner")
