...
@jsii.data_type(
    jsii_type="cdk8s-metaflow.MetadataDatabaseEnvOptions",
    jsii_struct_bases=[],
    name_mapping={
        "host": "host",
        "password": "password",
...
class MetadataDatabaseEnvOptions:
    def __init__(
        self,
        *,
        host: typing.Optional[builtins.str] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MetadataDatabaseEnvOptions.__init__)
            check_type(argname="argument host", value=host, expected_type=type_hints["host"])
            check_type(argname="argument password", value=password, expected_type=type_hints["password"])
    ...
    def __repr__(self) -> str:
        return "MetadataDatabaseEnvOptions(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class MetaflowServiceOptions:
    def __init__(
        ...
        *,
        ...
        metadatadb: typing.Optional[typing.Union[MetadataDatabaseEnvOptions, typing.Dict[str, typing.Any]]] = None,
        ...
        if isinstance(metadatadb, dict):
            metadatadb = MetadataDatabaseEnvOptions(**metadatadb)
    ...
    @builtins.property
    def metadatadb(self) -> typing.Optional[MetadataDatabaseEnvOptions]:
        '''
        :stability: experimental
        '''
        result = self._values.get("metadatadb")
        return typing.cast(typing.Optional[MetadataDatabaseEnvOptions], result)
...
class MetaflowUIOptions:
    def __init__(
        ...
        *,
        ...
        ingress: typing.Optional[typing.Union[IngressOptions, typing.Dict[str, typing.Any]]] = None,
        metadatadb: typing.Optional[typing.Union[MetadataDatabaseEnvOptions, typing.Dict[str, typing.Any]]] = None,
        metaflow_datastore_sysroot_s3: typing.Optional[builtins.str] = None,
        name_override: typing.Optional[builtins.str] = None,
        node_selector: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        pod_annotations: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        pod_security_context: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        ...
        if metadatadb is not None:
            self._values["metadatadb"] = metadatadb
        if metaflow_datastore_sysroot_s3 is not None:
            self._values["metaflow_datastore_sysroot_s3"] = metaflow_datastore_sysroot_s3
        if name_override is not None:
            self._values["name_override"] = name_override
        if node_selector is not None:
            self._values["node_selector"] = node_selector
    ...
    @builtins.property
    def metaflow_datastore_sysroot_s3(self) -> typing.Optional[builtins.str]:
        '''
        :stability: experimental
        '''
