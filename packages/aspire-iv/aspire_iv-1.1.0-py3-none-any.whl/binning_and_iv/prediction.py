...
def binning(df_binning, df_bins, columns, max_depth_,min_samples_split_, min_samples_leaf_):
    from sklearn.tree import DecisionTreeClassifier
    feature = []
    feature_bin = []
    for i in range(0,len(columns)):
        column = columns[i] 
        model = DecisionTreeClassifier(max_depth=max_depth_,min_samples_split=min_samples_split_, min_samples_leaf=min_samples_leaf_)
...
def DT_binning(dataframe, max_depth_=3,min_samples_split_=40, min_samples_leaf_=30, num_feature= [],cat_feature=[]):
    """
    Input :
    ...
    if num_feature != []:
        df_binning, df_bins, feature, feature_bin = binning(df_binning,df_bins, num_feature, max_depth_,min_samples_split_, min_samples_leaf_)
