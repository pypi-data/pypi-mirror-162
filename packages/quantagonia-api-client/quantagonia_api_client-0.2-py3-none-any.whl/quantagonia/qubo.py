...
from quantagonia.transport.runner import Runner
from quantagonia.transport.runner_factory import RunnerFactory
from quantagonia.transport.spec_builder import QUBOSpecBuilder, QuboSolverType
...
class QuboTerm(object):
    ...
    def __init__(self, coefficient : float, vars : list[QuboVariable]):
        super().__init__()
