...
class RunnerFactory:
	...
	@classmethod
	def getRunner(cls, connection : HybridSolverConnectionType, api_key : str = None, server : HybridSolverServers = HybridSolverServers.PROD):

		if connection == HybridSolverConnectionType.CLOUD:
			return CloudRunner(api_key, server)
