...
class MeiliWebsocketClient:
    ...
    docking_routine_handler(message: DockingRoutineMessage, vehicle: str) (callable) - a callable with a single parameter that will receive the message as a parameter
    ...
    def __init__(
        ...
        docking_routine_handler: t.Optional[t.Callable] = None,
        ...
        self.__docking_routine_handler = docking_routine_handler
    ...
    def process_message(
        ...
        processors = {
            constants.ACTION_DOCKING_ROUTINE: self.process_docking_routine,
    ...
    def process_docking_routine(self, message: dict, vehicle: t.Optional[str] = None):
        dock_message = DockingRoutineMessage(**message["data"])
        if self.__docking_routine_handler and callable(self.__docking_routine_handler):
            self.__docking_routine_handler(dock_message, vehicle)
