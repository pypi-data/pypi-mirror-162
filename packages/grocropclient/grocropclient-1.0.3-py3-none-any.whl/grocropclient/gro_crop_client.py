...
def handle_enums(obj):
  ...
  if isinstance(obj, dict):
    for k,v in obj.items():
      ...
      raise Exception("Couldn't handle the following with handle_enums: "+str(obj))
  return obj
...
class GroCropClient(object):
    ...
    def get_crop_budget_as_df(self, source_name, item_name, region_name):
        """Returns a given crop budget, as a pandas data frame.
           Use the source_name, item_name and region_name from the result of get_crop_budgets(…).
        """
...
######################################
    ...
    def get_cash_prices_spot_county_level(self, crop_id, county_id, start_date = None, end_date = None):
    ...
    def get_cash_prices_new_crop_county_level(self, crop_id, county_id, start_date = None, end_date = None):
        """Returns cash prices for a crop and a county."""
        params = { "source_id": SourceList.DTN_DISTRICT_AGGREGATED,
                   "frequency_id": 1,
                   "item_id":  crop_id,
    ...
    def get_basis_prices_spot_county_level(self, crop_id, county_id, start_date = None, end_date = None):
    ...
    def get_basis_prices_new_crop_county_level(self, crop_id, county_id, start_date = None, end_date = None):
        """Returns basis prices for a crop and a county."""
        params = { "source_id": SourceList.DTN_DISTRICT_AGGREGATED,
            "frequency_id": 1,
            "item_id":  crop_id,
