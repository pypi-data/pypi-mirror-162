...
def gltf_pbr_non_converted_extensions_operator(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: bool = None):
    ''' Add a node to the active tree for glTF export :file: addons/io_scene_gltf2/blender/com/gltf2_blender_ui.py\:59 <https://developer.blender.org/diffusion/BA/addons/io_scene_gltf2/blender/com/gltf2_blender_ui.py$59> _
...
def gltf_settings_node_operator(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: bool = None):
    ''' Add a node to the active tree for glTF export :file: addons/io_scene_gltf2/blender/com/gltf2_blender_ui.py\:30 <https://developer.blender.org/diffusion/BA/addons/io_scene_gltf2/blender/com/gltf2_blender_ui.py$30> _
