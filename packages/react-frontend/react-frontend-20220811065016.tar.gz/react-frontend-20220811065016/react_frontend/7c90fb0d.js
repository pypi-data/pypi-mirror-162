      ...
      `;if(!this._currentItem)return o.dy`<ha-circular-progress active></ha-circular-progress>`;const e=this._currentItem,t=this.hass.localize(`ui.components.media-browser.class.${e.media_class}`),i=e.children||[],a=m.Fn[e.media_class],d=e.children_media_class?m.Fn[e.children_media_class]:m.Fn.directory,p=e.thumbnail?this._getSignedThumbnail(e.thumbnail).then((e=>`url(${e})`)):"none";return o.dy`
          ...
          >
            ${this._error?o.dy`
                  ...
                  `:(u=e.media_content_id,u.startsWith(y)?o.dy`
                    <ha-browse-media-tts
                      .item=${e}
                      .hass=${this.hass}
                      .action=${this.action}
