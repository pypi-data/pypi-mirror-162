...
static void *init_type_wxDataViewColumn(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, sipKwdList, sipUnused, "J1@J8u|iEi", sipType_wxBitmapBundle, &bitmap, &bitmapState, &rendererWrapper, sipType_wxDataViewRenderer, &renderer, &model_column, &width, sipType_wxAlignment, &align, &flags))
        {
            PyErr_Clear();
