...
static sipEnumMemberDef enummembers_wxStandardPaths[] = {
    {sipName_ConfigFileConv_Dot, static_cast<int>( ::wxStandardPaths::ConfigFileConv_Dot), 528},
    {sipName_ConfigFileConv_Ext, static_cast<int>( ::wxStandardPaths::ConfigFileConv_Ext), 528},
    {sipName_Dir_Cache, static_cast<int>( ::wxStandardPaths::Dir_Cache), 529},
    {sipName_Dir_Desktop, static_cast<int>( ::wxStandardPaths::Dir_Desktop), 529},
    {sipName_Dir_Documents, static_cast<int>( ::wxStandardPaths::Dir_Documents), 529},
    {sipName_Dir_Downloads, static_cast<int>( ::wxStandardPaths::Dir_Downloads), 529},
    {sipName_Dir_Music, static_cast<int>( ::wxStandardPaths::Dir_Music), 529},
    {sipName_Dir_Pictures, static_cast<int>( ::wxStandardPaths::Dir_Pictures), 529},
    {sipName_Dir_Videos, static_cast<int>( ::wxStandardPaths::Dir_Videos), 529},
    {sipName_FileLayout_Classic, static_cast<int>( ::wxStandardPaths::FileLayout_Classic), 530},
    {sipName_FileLayout_XDG, static_cast<int>( ::wxStandardPaths::FileLayout_XDG), 530},
    {sipName_ResourceCat_Messages, static_cast<int>( ::wxStandardPaths::ResourceCat_Messages), 531},
    {sipName_ResourceCat_None, static_cast<int>( ::wxStandardPaths::ResourceCat_None), 531},
};
