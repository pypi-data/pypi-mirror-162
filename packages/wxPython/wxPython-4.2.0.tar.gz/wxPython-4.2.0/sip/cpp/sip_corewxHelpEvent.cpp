...
static sipEnumMemberDef enummembers_wxHelpEvent[] = {
    {sipName_Origin_HelpButton, static_cast<int>( ::wxHelpEvent::Origin_HelpButton), 264},
    {sipName_Origin_Keyboard, static_cast<int>( ::wxHelpEvent::Origin_Keyboard), 264},
    {sipName_Origin_Unknown, static_cast<int>( ::wxHelpEvent::Origin_Unknown), 264},
};
