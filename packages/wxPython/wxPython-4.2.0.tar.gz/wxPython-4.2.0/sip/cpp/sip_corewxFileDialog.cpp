...
sipVariableDef variables_wxFileDialog[] = {
    {PropertyVariable, sipName_Wildcard, &methods_wxFileDialog[35], &methods_wxFileDialog[52], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Paths, &methods_wxFileDialog[33], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Path, &methods_wxFileDialog[32], &methods_wxFileDialog[50], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Message, &methods_wxFileDialog[31], &methods_wxFileDialog[49], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_FilterIndex, &methods_wxFileDialog[29], &methods_wxFileDialog[48], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Filenames, &methods_wxFileDialog[28], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Filename, &methods_wxFileDialog[27], &methods_wxFileDialog[47], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ExtraControl, &methods_wxFileDialog[26], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Directory, &methods_wxFileDialog[25], &methods_wxFileDialog[46], SIP_NULLPTR, SIP_NULLPTR},
