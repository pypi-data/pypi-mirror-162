...
static sipEnumMemberDef enummembers_wxNavigationKeyEvent[] = {
    {sipName_FromTab, static_cast<int>( ::wxNavigationKeyEvent::FromTab), 385},
    {sipName_IsBackward, static_cast<int>( ::wxNavigationKeyEvent::IsBackward), 385},
    {sipName_IsForward, static_cast<int>( ::wxNavigationKeyEvent::IsForward), 385},
    {sipName_WinChange, static_cast<int>( ::wxNavigationKeyEvent::WinChange), 385},
};
