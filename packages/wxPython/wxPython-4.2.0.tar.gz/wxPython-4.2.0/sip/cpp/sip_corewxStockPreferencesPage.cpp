...
static sipEncodedTypeDef supers_wxStockPreferencesPage[] = {{436, 255, 1}};
...
static sipEnumMemberDef enummembers_wxStockPreferencesPage[] = {
    {sipName_Kind_Advanced, static_cast<int>( ::wxStockPreferencesPage::Kind_Advanced), 546},
    {sipName_Kind_General, static_cast<int>( ::wxStockPreferencesPage::Kind_General), 546},
};
