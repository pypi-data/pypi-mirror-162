...
class AffiliationScheme(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): An enumeration.., must be one of ["institution.v1.human-resources.university.identifiers.cam.ac.uk", "person.v1.human-resources.university.identifiers.cam.ac.uk", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.., must be one of ["institution.v1.human-resources.university.identifiers.cam.ac.uk", "person.v1.human-resources.university.identifiers.cam.ac.uk", ]  # noqa: E501
