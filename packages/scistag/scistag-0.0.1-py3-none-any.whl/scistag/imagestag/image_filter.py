...
from scistag.imagestag.image import *
from scistag.imagestag.image import __all__ as __allimage__
...
class ImageFilter:
    ...
    def filter(self, input_image: Union[IMAGE_SOURCE_TYPES, dict], bgr=False) -> Union[IMAGE_SOURCE_TYPES, dict]:
        """
        ...
        as response.
        :param bgr: If the image origin is OpenCV2 set this to true so the image will be handled as BGR/BGRA if it has
        3 or 4 channels.
        ...
        if isinstance(input_image, dict):
            ...
            input_image = {IMAGE_FILTER_IMAGE: Image(input_image, framework=ImsFramework.RAW)}
...
__all__ = ["ImageFilter", "IMAGE_FILTER_IMAGE", "IMAGE_FILTER_ORIGINAL_IMAGE", "IMAGE_FILTER_DATA",
           "IMAGE_FILTER_MAY_MODIFY", "Image", "ImsFramework"] + __allimage__
