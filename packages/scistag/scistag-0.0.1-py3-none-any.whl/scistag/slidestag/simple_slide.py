...
class SimpleSlide(Slide):
    ...
    * The Slide class itself
    ...
    @classmethod
    def create_simple_app(cls, name="SlideStag", title: Optional[str] = None, resolution=(1920, 1080),
                          dpi=96.0, on_load=None, on_paint=None,
                          on_tap=None, on_drag=None, on_mouse_move=None, repaint_frequency: float = 10.0) -> "SlideApp":
        """
        Setups a simple SlideStag application
        :param name: Application's name. "SlideStag" by default
