...
# Example commands
BioSAK sampling_GTDB_gnms -p Gamma_o -meta bac120_metadata_r202.tsv -taxon c__Gammaproteobacteria -r o
BioSAK sampling_GTDB_gnms -p Gamma_f -meta bac120_metadata_r202.tsv -taxon c__Gammaproteobacteria -r f -cpl 85 -ctm 5
