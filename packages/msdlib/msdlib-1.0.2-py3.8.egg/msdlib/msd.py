...
def plot_class_score(score, confmat, xrot=0, figure_dir=None, figtitle=None, figsize=(15, 5), show=False, cmap='Blues'):
    ...
    ax[0] = msd.plot_heatmap(score, axobj=ax[0], annotate=True, fmt='.3f', vmin=0, vmax=1, fig_title='Score Matrix', cmap=cmap, xrot=xrot)
    ax[1] = msd.plot_heatmap(confmat, axobj=ax[1], annotate=True, fmt='d', fig_title='Confusion Matrix', cmap=cmap, xrot=xrot)
    fig.tight_layout()
