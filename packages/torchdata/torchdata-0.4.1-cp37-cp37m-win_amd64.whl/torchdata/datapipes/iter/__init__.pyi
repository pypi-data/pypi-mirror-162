...
class IterDataPipe(IterableDataset[T_co], metaclass=_DataPipeMeta):
    ...
    def max_token_bucketize(self, max_token_count: int, len_fn: Callable= ..., min_len: int = 0, max_len: Optional[int] = None, buffer_size: int = 1000) -> IterDataPipe: ...
    ...
    def open_files_by_fsspec(self, mode: str = "r", **kwargs) -> IterDataPipe: ...
    ...
    def save_by_fsspec(self, mode: str = "w", filepath_fn: Optional[Callable] = None, **kwargs) -> IterDataPipe: ...
    ...
    def to_map_datapipe(self, key_value_fn: Optional[Callable] = None) -> IterDataPipe: ...
