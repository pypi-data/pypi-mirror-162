...
print("0" + pathlib.Path(__file__).parent.absolute())
print("1" + os.path.dirname(os.path.realpath(__file__)))
print("2" + sys.path[0])
print("3" + os.path.dirname(os.path.realpath(sys.argv[0])))
