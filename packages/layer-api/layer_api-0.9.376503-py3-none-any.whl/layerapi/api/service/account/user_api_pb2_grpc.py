...
class UserAPIStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetOrganizationMembersRole = channel.unary_unary(
                '/api.UserAPI/SetOrganizationMembersRole',
                request_serializer=api_dot_service_dot_account_dot_user__api__pb2.SetOrganizationMembersRoleRequest.SerializeToString,
                response_deserializer=api_dot_service_dot_account_dot_user__api__pb2.SetOrganizationMembersRoleResponse.FromString,
                )
...
class UserAPIServicer(object):
    ...
    def SetOrganizationMembersRole(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_UserAPIServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SetOrganizationMembersRole': grpc.unary_unary_rpc_method_handler(
                    servicer.SetOrganizationMembersRole,
                    request_deserializer=api_dot_service_dot_account_dot_user__api__pb2.SetOrganizationMembersRoleRequest.FromString,
                    response_serializer=api_dot_service_dot_account_dot_user__api__pb2.SetOrganizationMembersRoleResponse.SerializeToString,
            ),
...
class UserAPI(object):
    ...
    @staticmethod
    def SetOrganizationMembersRole(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.UserAPI/SetOrganizationMembersRole',
            api_dot_service_dot_account_dot_user__api__pb2.SetOrganizationMembersRoleRequest.SerializeToString,
            api_dot_service_dot_account_dot_user__api__pb2.SetOrganizationMembersRoleResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
