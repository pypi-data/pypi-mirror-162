...
class UserAPIStub:
    ...
    SetOrganizationMembersRole: grpc.UnaryUnaryMultiCallable[
        api.service.account.user_api_pb2.SetOrganizationMembersRoleRequest,
        api.service.account.user_api_pb2.SetOrganizationMembersRoleResponse]
...
class UserAPIServicer(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def SetOrganizationMembersRole(self,
        request: api.service.account.user_api_pb2.SetOrganizationMembersRoleRequest,
        context: grpc.ServicerContext,
    ) -> api.service.account.user_api_pb2.SetOrganizationMembersRoleResponse: ...
