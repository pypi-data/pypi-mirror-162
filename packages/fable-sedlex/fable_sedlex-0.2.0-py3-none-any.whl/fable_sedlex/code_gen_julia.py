...
def codegen_julia(import_head: str, cu: compiled_unit) -> Doc:
    ...
    decision_funcs : Any = empty(ObjectExpr5())
    tbl_cnt : int = 0
    ...
    def _cg_state_func(lang: lang_3, import_head: str=import_head, cu: compiled_unit=cu) -> Doc:
        if lang.tag == 3:
            ...
            def arrow_14(s_2: str, lang: lang_3=lang) -> Doc:
                return word(s_2)

            push_later_toplevel(Doc_op_Addition_Z492644C0(Doc_op_Addition_Z492644C0(Doc_op_Addition_Z492644C0(word("const"), word(func_table)), word("=")), parens(Doc_op_Multiply_Z492644C0(seplist(word(", "), map_1(arrow_14, names_1)), word(",")))))
