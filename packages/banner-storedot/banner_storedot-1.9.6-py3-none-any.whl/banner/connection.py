...
class NewareTestController(NewareCacheController):
    ...
    def store(
        ...
        except (TypeError, KeyError, UndefinedVariableError, redis.ResponseError):
            raise ValueError(f'Bad Input')
    ...
    def retrieve(
        ...
        try:
            ...
            cycles = list(cache_data[NewareTestController.VALUE_GROUP_KEY]) # Ordered by default
        ...
        except (AssertionError, KeyError, UndefinedVariableError, redis.ResponseError):
            return DataFrame()
