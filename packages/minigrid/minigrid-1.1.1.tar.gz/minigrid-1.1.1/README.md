...
There are a variety of wrappers to change the observation format available in [gym_minigrid/wrappers.py](/minigrid/wrappers.py). 
...
- `OBJECT_TO_IDX` and `COLOR_TO_IDX` mapping can be found in [gym_minigrid/minigrid.py](minigrid/minigrid.py)
...
[gym_minigrid/minigrid.py](minigrid/minigrid.py) source file.

## Included Environments

The environments listed below are implemented in the [gym_minigrid/envs](/minigrid/envs) directory.
