...
class tracker:
    ...
    def detect_drift(self, train_data, test_data, io_directory = None, target_variable = None, categorical_features = None):
        data = {}
        data["project"] = self.project
        data["model_name"] = self.model_name
        data["client_ip"] = "None"
        ...
        try:
            if io_directory == None:
                ...
                train_file = io_directory + "/" + str(self.project) +"_" + self.model_name + "_train_data.csv"
                train_data.to_csv(train_file,index = False, header=True)
                test_file = io_directory + "/" + str(self.project) +"_" + self.model_name + "_test_data.csv"
                test_data.to_csv(test_file,index = False, header=True)
