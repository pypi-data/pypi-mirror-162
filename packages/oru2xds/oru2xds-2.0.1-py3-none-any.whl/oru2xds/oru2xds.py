...
# TODO: Use setuptools and upload software to PyPI https://pypi.org/
...
class Oru2xds:
	def __init__(self):
		...
		logger.info("Starting oru2xds %s ...", self.version)
