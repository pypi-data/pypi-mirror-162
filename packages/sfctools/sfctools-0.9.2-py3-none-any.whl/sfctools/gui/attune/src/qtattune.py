        ...
        try:
            ...
            #with open(folder + "./mainloop.py","w") as file:
                if self.mainloop_str == "" or overwrite:
                    ...
                    yes = self.ask_question('', "WARNING - You are about to overwrite the mainloop.py script. This operation cannot be reverted. Continue?")
                    if not yes:
                        return
...
"""
    ...
    def resizeEvent(self, event):
        ...
        # resize transaction
        w = 741
        h = 291 + max(0,self.frameGeometry().height()-985)
