...
insert_sales_record = """
    ...
    from
        ...
        msm.abo,
        msm.city,
        (case when f."gst-number" is not null then 'B2B' else msm."store-b2b" end) as "store-b2b",
    ...
    from
        ...
        msm.abo,
        msm.city,
        (case when f1."gst-number" is not null then 'B2B' else msm."store-b2b" end) as "store-b2b",
        msm."month-diff" as "store-month-diff",
        msm."opened-at" as "store-opened-at",
        msm."franchisee-id",
        msm."franchisee-name",
