...
class IAlgorithm(QuantConnect.Interfaces.ISecurityInitializerProvider, QuantConnect.Interfaces.IAccountCurrencyProvider, metaclass=abc.ABCMeta):
    ...
    @overload
    def GetParameter(self, name: str, defaultValue: typing.Optional[int] = None) -> typing.Optional[int]:
        """
    ...
    @overload
    def GetParameter(self, name: str, defaultValue: typing.Optional[float] = None) -> typing.Optional[float]:
        """
