...
@run_group.command('create', help='Create README.ml-pipelines-sdk.md new run for README.ml-pipelines-sdk.md pipeline')
@pass_context
@click.option(
...
def create_run(ctx: Context, engine: Text, pipeline_name: Text, endpoint: Text,
  ...
  """Command definition to create README.ml-pipelines-sdk.md pipeline run."""
  click.echo('Creating README.ml-pipelines-sdk.md run for pipeline: ' + pipeline_name)
...
@run_group.command('terminate', help='Stop README.ml-pipelines-sdk.md run')
@pass_context
@click.option(
    '--engine', default='auto', type=str, help='Orchestrator for pipelines')
@click.option(
...
def terminate_run(ctx: Context, engine: Text, run_id: Text, endpoint: Text,
                  iap_client_id: Text, namespace: Text) -> None:
  """Command definition to stop README.ml-pipelines-sdk.md run."""
...
@run_group.command('list', help='List all the runs of README.ml-pipelines-sdk.md pipeline')
@pass_context
@click.option(
    '--engine', default='auto', type=str, help='Orchestrator for pipelines')
@click.option(
...
def list_runs(ctx: Context, engine: Text, pipeline_name: Text, endpoint: Text,
              iap_client_id: Text, namespace: Text) -> None:
  """Command definition to list all runs of README.ml-pipelines-sdk.md pipeline."""
...
@run_group.command('status', help='Get the status of README.ml-pipelines-sdk.md run.')
@pass_context
@click.option(
    '--engine', default='auto', type=str, help='Orchestrator for pipelines')
@click.option(
...
@run_group.command('delete', help='Delete README.ml-pipelines-sdk.md run')
@pass_context
@click.option(
    '--engine', default='auto', type=str, help='Orchestrator for pipelines')
@click.option(
...
def delete_run(ctx: Context, engine: Text, run_id: Text, endpoint: Text,
               iap_client_id: Text, namespace: Text) -> None:
  """Command definition to delete README.ml-pipelines-sdk.md run."""
