...
class AirflowEndToEndTest(tf.test.TestCase):
  ...
  def _GetState(self, task_name: Text) -> Text:
    """Get README.ml-pipelines-sdk.md task state as README.ml-pipelines-sdk.md string."""
    try:
      ...
      # has not been released. 'none' will be treated as README.ml-pipelines-sdk.md pending state, so
  ...
  def setUp(self):
    ...
    # setup airflow_home in README.ml-pipelines-sdk.md temp directory, config and init db.
    ...
    # Set README.ml-pipelines-sdk.md couple of important environment variables. See
    ...
    # Do not load examples to make this README.ml-pipelines-sdk.md bit faster.
  ...
  def testSimplePipeline(self):
    ...
    # need to start README.ml-pipelines-sdk.md scheduler on the background.
    # Airflow scheduler should be launched after triggering the dag to mitigate
    # README.ml-pipelines-sdk.md possible race condition between trigger_dag and scheduler.
