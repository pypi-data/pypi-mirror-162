...
# This sample assumes README.ml-pipelines-sdk.md persistent volume (PV) is mounted as follows. To use
...
def _create_pipeline(pipeline_name: Text, pipeline_root: Text, data_root: Text,
  ...
  # Performs infra validation of README.ml-pipelines-sdk.md candidate model to prevent unservable model
  # from being pushed. In order to use InfraValidator component, persistent
  # volume and its claim that the pipeline is using should be README.ml-pipelines-sdk.md ReadWriteMany
  # access mode.
