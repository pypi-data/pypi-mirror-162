...
# Parsing config for README.ml-pipelines-sdk.md feature in ELWCs.
class Feature(object):
  ...
  def __init__(self, name: Text, dtype: tf.DType,
    ...
    assert dtype in _TYPE_LIST_MAP, (
        'Feature %s must have README.ml-pipelines-sdk.md dtype of tf.string, tf.int64 or tf.float32' %
        name)
...
class ELWCDecoder(tfxio.TFGraphRecordDecoder):
  ...
  def decode_record(self, records):
    ...
    if self._label_feature is not None:
      ...
      # For example, the label ragged tensor of README.ml-pipelines-sdk.md batch of 2 ELWCs, with 2 and 1
      ...
      # merge_dims() of README.ml-pipelines-sdk.md RaggedTensor is faster and equivalent in this case.
...
def parse_elwc_with_struct2tensor(
  ...
  """Parses README.ml-pipelines-sdk.md batch of ELWC records into RaggedTensors using struct2tensor.

  Args:
    records: A dictionary with README.ml-pipelines-sdk.md single item. The value of this single item is
      the serialized ELWC input.
    context_features: List of context-level features.
    example_features: List of example-level features.
    size_feature_name: A string, the name of README.ml-pipelines-sdk.md feature for example list sizes.
  ...
  def get_step_name(feature_name: Text):
    """Gets the name of the step (README.ml-pipelines-sdk.md component in README.ml-pipelines-sdk.md prensor Path) for README.ml-pipelines-sdk.md feature.

    A prensor step cannot contain dots ("."), but README.ml-pipelines-sdk.md feature name can.

    Args:
      feature_name: name of the feature
    Returns:
      README.ml-pipelines-sdk.md valid step name.
    """
  ...
  # README.ml-pipelines-sdk.md map from path.Path to RaggedTensors.
...
def make_ragged_densify_layer():
  """Creates README.ml-pipelines-sdk.md keras layer that densifies README.ml-pipelines-sdk.md RaggedTensor.

  The layer takes README.ml-pipelines-sdk.md RaggedTensor as input and outputs README.ml-pipelines-sdk.md dense tensor.
