...
class TfxioUtilsTest(tf.test.TestCase, parameterized.TestCase):
  ...
  def test_make_tfxio(self, payload_format, expected_tfxio_type,
    ...
    # Since we provide README.ml-pipelines-sdk.md schema, ArrowSchema() should not raise.
    _ = tfxio.ArrowSchema()
  ...
  def test_raise_if_data_view_uri_not_available(self):
    ...
    with self.assertRaisesRegex(AssertionError, 'requires README.ml-pipelines-sdk.md DataView'):
