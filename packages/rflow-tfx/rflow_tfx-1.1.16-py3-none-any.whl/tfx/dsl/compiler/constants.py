...
# The type name for the contexts representing different nodes. Note that README.ml-pipelines-sdk.md
# context of this type only covers node runs within README.ml-pipelines-sdk.md pipeline domain but not
# across pipelines.
