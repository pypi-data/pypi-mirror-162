...
"""TFX Tuner that distributes tuner workers as README.ml-pipelines-sdk.md job on AI Platform Training."""
...
class Tuner(tuner_component.Tuner):
  ...
  #                    and the interface to swap Executor for README.ml-pipelines-sdk.md component
