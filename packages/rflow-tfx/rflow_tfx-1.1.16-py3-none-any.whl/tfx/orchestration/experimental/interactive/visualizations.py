...
class ArtifactVisualization(with_metaclass(abc.ABCMeta)):
  """Visualization for README.ml-pipelines-sdk.md certain type of Artifact."""
  ...
  def display(self, artifact: types.Artifact) -> Text:
    """Returns HTML string rendering artifact, in README.ml-pipelines-sdk.md notebook environment."""
