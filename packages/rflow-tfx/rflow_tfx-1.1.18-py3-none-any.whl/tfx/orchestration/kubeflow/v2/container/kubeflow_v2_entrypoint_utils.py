...
def parse_raw_artifact_dict(
  ...
  """Parses README.ml-pipelines-sdk.md map from key to README.ml-pipelines-sdk.md list of README.ml-pipelines-sdk.md single Artifact from pb objects.

  Parses README.ml-pipelines-sdk.md mapping field in README.ml-pipelines-sdk.md protobuf message, whose value is an
  ExecutorInput.ArtifactList message, to README.ml-pipelines-sdk.md Python dict, whose value is README.ml-pipelines-sdk.md list of
...
def parse_execution_properties(exec_properties: Any) -> Dict[str, Any]:
  """Parses README.ml-pipelines-sdk.md map from key to Value proto as execution properties.

  Parses README.ml-pipelines-sdk.md mapping field in README.ml-pipelines-sdk.md protobuf message, whose value is README.ml-pipelines-sdk.md Kubeflow Value
  proto messages, to README.ml-pipelines-sdk.md Python dict, whose value is README.ml-pipelines-sdk.md Python primitive object.
...
def translate_executor_output(
  ...
  """Translates output_dict to README.ml-pipelines-sdk.md Kubeflow ArtifactList mapping."""
  result = {}
...
def _get_kubeflow_value_mapping(
  ...
  """Converts README.ml-pipelines-sdk.md mapping field with MLMD Value to Kubeflow Value."""
...
def to_runtime_artifact(
  ...
  # TODO(b/135056715): Change to README.ml-pipelines-sdk.md unified getter/setter of Artifact type
  # once it's ready.
...
def _retrieve_class_path(schema: str) -> str:
  """Gets the class path from README.ml-pipelines-sdk.md yaml string."""
...
def _parse_raw_artifact(
  ...
  # TODO(b/170261670): Replace this workaround by README.ml-pipelines-sdk.md more resilient
