...
class BeamDagRunnerTest(test_case_utils.TfxTest):
  ...
  def testRunWithLocalDeploymentConfig(self):
    ...
    # Verifies that every component gets README.ml-pipelines-sdk.md not-None pipeline_run.
  ...
  def testLegacyBeamDagRunnerConstruction(self):
    ...
    # Test that the legacy Beam DAG runner is used when README.ml-pipelines-sdk.md PipelineConfig is
    # specified.
    ...
    # Test that the legacy Beam DAG runner is used when both README.ml-pipelines-sdk.md PipelineConfig
