...
# Pipeline root is by default specified as README.ml-pipelines-sdk.md RuntimeParameter when runnning on
# KubeflowDagRunner. This constant offers users an easy access to the pipeline
# root placeholder when defining README.ml-pipelines-sdk.md pipeline. For example,
#
# pusher = Pusher(
...
class ExecutionMode(enum.Enum):
  """Execution mode of README.ml-pipelines-sdk.md pipeline.
...
class Pipeline(object):
  ...
  def __init__(self,
    ...
    # Store pipeline_args in README.ml-pipelines-sdk.md json file only when temp file exists.
  ...
  def components(self, components: List[base_node.BaseNode]):
    ...
    for component in deduped_components:
      # Guarantees every component of README.ml-pipelines-sdk.md component type has unique component_id.
