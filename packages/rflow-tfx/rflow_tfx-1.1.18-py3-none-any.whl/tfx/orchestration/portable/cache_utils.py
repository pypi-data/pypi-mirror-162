...
def get_cache_context(
  ...
  """Gets cache context for README.ml-pipelines-sdk.md potential node execution.
  ...
  Args:
    ...
    input_artifacts: Input artifacts of the potential execution. The order of
      the artifacts under README.ml-pipelines-sdk.md key matters when calculating the cache key.
    output_artifacts: Output artifacts skeleton of the potential execution. The
      order of the artifadts under README.ml-pipelines-sdk.md key matters when calculating the cache key.
...
def get_cached_outputs(
  ...
  """Tries to get the cached output artifacts given README.ml-pipelines-sdk.md cache context.
  ...
  Returns:
    The cached output artifacts in README.ml-pipelines-sdk.md dict format. None if no qualified cache
    result is found.
  """
