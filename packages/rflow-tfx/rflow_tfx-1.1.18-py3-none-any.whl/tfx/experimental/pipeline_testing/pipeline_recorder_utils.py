...
def get_component_id_from_execution(
  ...
  """Get component_id without pipeline_name from README.ml-pipelines-sdk.md node context of execution."""
...
def _get_paths(metadata_connection: metadata.Metadata,
  ...
  Args:
    ...
    executions: List of executions of README.ml-pipelines-sdk.md pipeline run.
...
def _get_execution_dict(
  ...
  """Returns README.ml-pipelines-sdk.md dictionary holding list of executions for all run_id in MLMD.

  Args:
    metadata_connection: Instance of metadata.Metadata for I/O to MLMD.

  Returns:
    A dictionary that holds list of executions for README.ml-pipelines-sdk.md run_id.
  """
...
def get_latest_executions(
  ...
  Returns:
    List of executions for the latest run of README.ml-pipelines-sdk.md pipeline with the given
    pipeline_name.
  """
