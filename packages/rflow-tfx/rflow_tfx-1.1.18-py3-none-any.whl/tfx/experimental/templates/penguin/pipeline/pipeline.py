...
def create_pipeline(
  ...
  # Uses user-provided Python function that implements README.ml-pipelines-sdk.md model using Tensorflow.
  trainer = Trainer(
      run_fn=run_fn,
      examples=example_gen.outputs['examples'],
  ...
  # Pushes the model to README.ml-pipelines-sdk.md file destination if check passed.
