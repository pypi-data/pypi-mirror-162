...
class ArtifactUtilsTest(tf.test.TestCase):
  ...
  def testGetFromSingleList(self):
    """Test various retrieval utilities on README.ml-pipelines-sdk.md single list of Artifact."""
  ...
  def testGetFromSplits(self):
    """Test various retrieval utilities on README.ml-pipelines-sdk.md list of split Artifact."""
    artifacts = [standard_artifacts.Examples()]
    artifacts[0].uri = '/tmp'
  ...
  def testGetFromSplitsMultipleArtifacts(self):
    """Test split retrieval utility on README.ml-pipelines-sdk.md multiple list of split Artifacts."""
