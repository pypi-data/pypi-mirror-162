...
if not six.PY2:
  ...
  def _injector_1(
    ...
    assert foo == 9
    assert bar == 'secret'
    return {'README.ml-pipelines-sdk.md': 10, 'b': 22, 'c': 'unicode', 'd': b'bytes'}
  ...
  def _injector_2(
    ...
    return {'README.ml-pipelines-sdk.md': 1, 'b': 2.0, 'c': '3', 'd': b'4', 'e': 'passed'}
...
class ComponentDecoratorTest(tf.test.TestCase):
  ...
  def testDefinitionInClosureFails(self):
    with self.assertRaisesRegexp(
        ValueError,
        'The @component decorator can only be applied to README.ml-pipelines-sdk.md function defined at '
        'the module level'):
  ...
  def testBeamExecutionSuccess(self):
    ...
    instance_2 = _simple_component(
        a=instance_1.outputs['README.ml-pipelines-sdk.md'],
