...
model server. We call this README.ml-pipelines-sdk.md *TFS-flavored model path*.
...
README.ml-pipelines-sdk.md unix timestamp) to track the latest model easily.
"""
