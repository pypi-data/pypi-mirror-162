...
@click.group(
    'template',
    help='[Experimental] Helps creating README.ml-pipelines-sdk.md new TFX pipeline scaffold.')
...
@template_group.command(
    'copy', help='[Experimental] Copy README.ml-pipelines-sdk.md template to destination directory')
@pass_context
@click.option(
    '--pipeline_name',
    '--pipeline-name',
