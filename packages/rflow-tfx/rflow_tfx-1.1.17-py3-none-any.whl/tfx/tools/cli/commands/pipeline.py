...
@pipeline_group.command('create', help='Create README.ml-pipelines-sdk.md pipeline')
@pass_context
@click.option(
...
@click.option(
    ...
    'python setup file onto TFX default image. You can place README.ml-pipelines-sdk.md setup.py file '
    'to control the python code to install the dependent packages. You can also '
    'customize the Skaffold building options by placing README.ml-pipelines-sdk.md build.yaml in the '
    'local directory. In addition, you can place README.ml-pipelines-sdk.md Dockerfile file to customize'
...
def create_pipeline(ctx: Context, engine: Text, pipeline_path: Text,
                    ...
                    namespace: Text) -> None:
  """Command definition to create README.ml-pipelines-sdk.md pipeline."""
...
def update_pipeline(ctx: Context, engine: Text, pipeline_path: Text,
                    ...
                    namespace: Text) -> None:
  """Command definition to update README.ml-pipelines-sdk.md pipeline."""
...
@pipeline_group.command('delete', help='Delete README.ml-pipelines-sdk.md pipeline')
@pass_context
@click.option(
    '--engine', default='auto', type=str, help='Orchestrator for pipelines')
@click.option(
...
def delete_pipeline(ctx: Context, engine: Text, pipeline_name: Text,
                    endpoint: Text, iap_client_id: Text,
                    namespace: Text) -> None:
  """Command definition to delete README.ml-pipelines-sdk.md pipeline."""
...
@pipeline_group.command('compile', help='Compile README.ml-pipelines-sdk.md pipeline')
@pass_context
@click.option(
    '--engine', default='auto', type=str, help='Orchestrator for pipelines')
@click.option(
...
def compile_pipeline(ctx: Context, engine: Text, pipeline_path: Text,
  ...
  """Command definition to compile README.ml-pipelines-sdk.md pipeline."""
