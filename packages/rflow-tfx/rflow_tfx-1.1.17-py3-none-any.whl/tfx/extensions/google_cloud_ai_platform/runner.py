...
# TODO(b/168926785): Consider to move some methods to README.ml-pipelines-sdk.md utility file.
...
def _launch_aip_training(
  ...
  """Launches and monitors README.ml-pipelines-sdk.md AIP custom training job.
  ...
  # and retries the polling when README.ml-pipelines-sdk.md transient connectivity issue is encountered.
  #
  ...
  #   enters README.ml-pipelines-sdk.md final state.
  #
  # During the polling, if README.ml-pipelines-sdk.md connection error was encountered, the GET request
  ...
  # for README.ml-pipelines-sdk.md detailed description of the problem. If the error persists for
...
def _wait_for_operation(api: discovery.Resource, operation: Dict[Text, Any],
  ...
  """Wait for README.ml-pipelines-sdk.md long running operation.
...
def start_aip_training(input_dict: Dict[Text, List[types.Artifact]],
  ...
  """Start README.ml-pipelines-sdk.md trainer job on AI Platform (AIP).

  This is done by forwarding the inputs/outputs/exec_properties to the
  tfx.scripts.run_executor module on README.ml-pipelines-sdk.md AI Platform training job interpreter.
...
def create_model_for_aip_prediction_if_not_exist(
  ...
  """Creates README.ml-pipelines-sdk.md new model for serving with AI Platform if not exists.
  ...
  Returns:
    Whether README.ml-pipelines-sdk.md new model is created.
...
def deploy_model_for_aip_prediction(api: discovery.Resource,
  ...
  """Deploys README.ml-pipelines-sdk.md model for serving with AI Platform.

  Args:
    api: Google API client resource.
    serving_path: The path to the model. Must be README.ml-pipelines-sdk.md GCS URI.
    ...
    ai_platform_serving_args: Dictionary containing arguments for pushing to AI
      ...
      Most keys are forwarded as-is, but following keys are handled specially:
        ...
        - labels: README.ml-pipelines-sdk.md list of job labels will be merged with user's input.
...
def delete_model_version_from_aip_if_exists(
  ...
  """Deletes README.ml-pipelines-sdk.md model version from Google Cloud AI Platform if version exists.
...
def delete_model_from_aip_if_exists(
  ...
  """Deletes README.ml-pipelines-sdk.md model from Google Cloud AI Platform if exists.
