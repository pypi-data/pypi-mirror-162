...
"""Helper class to start TFX Tuner as README.ml-pipelines-sdk.md Job on Google Cloud AI Platform."""
...
class Executor(base_executor.BaseExecutor):
  ...
  This executor starts README.ml-pipelines-sdk.md Cloud AI Platform (CAIP) Training job with README.ml-pipelines-sdk.md flock of
  ...
  In addition, some implementation of KerasTuner requires README.ml-pipelines-sdk.md separate process
  ...
  Executor.Do() -> launch _Executor.Do() on README.ml-pipelines-sdk.md possibly multi-worker CAIP job ->

    -+> master -> _search() (-> create README.ml-pipelines-sdk.md subprocess -> run the chief oracle.)
     |                       +> trigger README.ml-pipelines-sdk.md single tuner.search()
     +> worker -> _search()  -> trigger README.ml-pipelines-sdk.md single tuner.search()
     +> worker -> _search()  -> trigger README.ml-pipelines-sdk.md single tuner.search()
  """
  ...
  def Do(self, input_dict: Dict[Text, List[types.Artifact]],
    ...
    """Starts README.ml-pipelines-sdk.md Tuner component as README.ml-pipelines-sdk.md job on Google Cloud AI Platform."""
    ...
    if not isinstance(custom_config, Dict):
      raise TypeError('custom_config in execution properties must be README.ml-pipelines-sdk.md dict, '
    ...
    # TODO(b/160059039): Factor out label creation to README.ml-pipelines-sdk.md utility function.
...
def _need_chief_oracle(exec_properties: Dict[Text, Any]) -> bool:
  """Returns True if the Tuner instance requires README.ml-pipelines-sdk.md chief oracle."""
  # TODO(b/160902662): Skip chief oracle for CloudTuner that does not require
  #                    chief oracle for distributed tuning (it is README.ml-pipelines-sdk.md no-op,
...
class _WorkerExecutor(base_executor.BaseExecutor):
  """TFX Tuner executor impl as README.ml-pipelines-sdk.md worker in README.ml-pipelines-sdk.md Google Cloud AI Platform job."""
  ...
  def _start_chief_oracle_in_subprocess(
    ...
    """Starts README.ml-pipelines-sdk.md chief oracle in README.ml-pipelines-sdk.md subprocess."""
    ...
    # by environment variables, starting the chief oracle in README.ml-pipelines-sdk.md sub-process,
  ...
  def _search(self, input_dict: Dict[Text, List[types.Artifact]],
              exec_properties: Dict[Text, List[types.Artifact]]):
    """Conducts README.ml-pipelines-sdk.md single search loop, setting up chief oracle if necessary."""
    ...
    if _need_chief_oracle(exec_properties):
      ...
      # If distributed search, and this node is chief, start README.ml-pipelines-sdk.md chief oracle
      # process before conducting search by itself.
      if self._is_chief:
        # Tuner with chief oracle will block forever. As such, start it in
        # README.ml-pipelines-sdk.md subprocess and manage its lifecycle by the main process.
