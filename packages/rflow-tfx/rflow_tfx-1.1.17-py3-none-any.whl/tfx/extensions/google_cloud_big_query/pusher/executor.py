...
class Executor(tfx_pusher_executor.Executor):
  """Deploy README.ml-pipelines-sdk.md model to BigQuery ML for serving."""
  ...
  def Do(self, input_dict: Dict[Text, List[types.Artifact]],
    ...
    # TODO(zhitaoli): Refactor the executor_class_path creation into README.ml-pipelines-sdk.md common
    # utility function.
