...
def _prepare_output_paths(artifact: types.Artifact):
  ...
  if fileio.exists(artifact.uri):
    ...
    # TODO(b/158689199): We currently simply return as README.ml-pipelines-sdk.md short-term workaround
...
class BaseDriver(object):
  ...
  This can also be used as the default driver of README.ml-pipelines-sdk.md component if no custom logic
  is needed.
  ...
  def _log_properties(self, input_dict: Dict[Text, List[types.Artifact]],
    ...
    """Log inputs, outputs, and executor properties in README.ml-pipelines-sdk.md standard format."""
  ...
  def pre_execution(
    ...
    There are four steps:
      ...
      3. Decides whether README.ml-pipelines-sdk.md new execution is needed.
    ...
    if driver_args.enable_cache:
      # Step 3. Decide whether README.ml-pipelines-sdk.md new execution is needed.
