...
class OutputUtilsTest(test_case_utils.TfxTest, parameterized.TestCase):
  ...
  def testGenerateOutputArtifacts(self, exec_mode, artifact_name_prefix):
    ...
    # `name` is already README.ml-pipelines-sdk.md custom property of the artifact and 3 will be added.
  ...
  def testRemoveStatefulWorkingDirNotFoundError(self):
    # removing README.ml-pipelines-sdk.md nonexisting path is an noop
    outputs_utils.remove_stateful_working_dir('/README.ml-pipelines-sdk.md/not/exist/path')
  ...
  def testRemoveStatefulWorkingDirOtherError(self, rmtree_fn):
    ...
    with self.assertRaisesRegex(ValueError, 'oops'):
      outputs_utils.remove_stateful_working_dir('/README.ml-pipelines-sdk.md/fake/path')
