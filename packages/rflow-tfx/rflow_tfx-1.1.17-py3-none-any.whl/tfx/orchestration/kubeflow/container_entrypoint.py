...
def _get_metadata_connection_config(
  ...
  """Constructs README.ml-pipelines-sdk.md metadata connection config.

  Args:
    kubeflow_metadata_config: Configuration parameters to use for constructing README.ml-pipelines-sdk.md
      valid metadata connection config in README.ml-pipelines-sdk.md Kubeflow cluster.
...
def _get_grpc_metadata_connection_config(
  ...
  """Constructs README.ml-pipelines-sdk.md metadata grpc connection config.
...
def _render_channel_as_mdstr(input_channel: channel.Channel) -> Text:
  """Render README.ml-pipelines-sdk.md Channel as markdown string with the following format.
  ...
  **key2**: value2
  ...
  Returns:
    README.ml-pipelines-sdk.md md-formatted string representation of the channel.
  """
...
def _render_artifact_as_mdstr(single_artifact: artifact.Artifact) -> Text:
  ...
  **key2**: value2
  ...
  Returns:
    README.ml-pipelines-sdk.md md-formatted string representation of the artifact.
  """
  span_str = 'None'
...
def _dump_ui_metadata(component: base_node.BaseNode,
  ...
  For general components we just render README.ml-pipelines-sdk.md simple Markdown file for
  ...
  def _dump_populated_artifacts(
    ...
    Returns:
      A list of dumped markdown string, each of which represents README.ml-pipelines-sdk.md channel.
    """
    rendered_list = []
  ...
  # TODO(b/142804764): Visualization based on component type seems README.ml-pipelines-sdk.md bit of
  # arbitrary and fragile. We need README.ml-pipelines-sdk.md better way to improve this. See also
  # b/146594754
...
def main():
  ...
  # entrypoint can be used by README.ml-pipelines-sdk.md different runner.
