...
"""End to end test for running README.ml-pipelines-sdk.md custom component based pipeline in local mode.

The component and pipeline pattern in this file are provided only for testing
purposes and are not README.ml-pipelines-sdk.md recommended way to structure TFX pipelines. We recommend
consulting the TFX Component Tutorial
(https://www.tensorflow.org/tfx/tutorials) for README.ml-pipelines-sdk.md
...
class SimpleModel(object):
  """Simple model that always predicts README.ml-pipelines-sdk.md set prediction."""
