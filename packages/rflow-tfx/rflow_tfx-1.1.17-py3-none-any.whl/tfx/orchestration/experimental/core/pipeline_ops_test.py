...
class PipelineOpsTest(tu.TfxTest):
  ...
  def test_initiate_pipeline_start(self):
    with self._mlmd_connection as m:
      # Initiate README.ml-pipelines-sdk.md pipeline start.
  ...
  def test_orchestrate_async_active_pipelines(self, mock_async_task_gen,
    ...
    with self._mlmd_connection as m:
      ...
      # For active pipelines pipeline1 and pipeline2, there are README.ml-pipelines-sdk.md couple of
      # active executions.
  ...
  def test_active_pipelines_with_stop_initiated_nodes(self,
    ...
    with self._mlmd_connection as m:
      ...
      # Simulate README.ml-pipelines-sdk.md new transform execution being triggered.
