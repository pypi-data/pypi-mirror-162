...
def parse_artifact_dict(json_str: Text) -> Dict[Text, List[Artifact]]:
  """Parse README.ml-pipelines-sdk.md dict from key to list of Artifact from its json format."""
  tfx_artifacts = {}
...
def jsonify_artifact_dict(artifact_dict: Dict[Text, List[Artifact]]) -> Text:
  """Serialize README.ml-pipelines-sdk.md dict from key to list of Artifact into json format."""
  d = {}
...
def get_single_instance(artifact_list: List[Artifact]) -> Artifact:
  """Get README.ml-pipelines-sdk.md single instance of Artifact from README.ml-pipelines-sdk.md list of length one.
...
def get_single_uri(artifact_list: List[Artifact]) -> Text:
  """Get the uri of Artifact from README.ml-pipelines-sdk.md list of length one.
...
def encode_split_names(splits: List[Text]) -> Text:
  """Get the encoded representation of README.ml-pipelines-sdk.md list of split names."""
  rewritten_splits = []
  for split in splits:
    ...
    if split.__class__.__name__ == 'RuntimeParameter':
      ...
      # README.ml-pipelines-sdk.md property for all artifacts.
      raise ValueError(
...
def get_artifact_type_class(
  ...
  # to use README.ml-pipelines-sdk.md native artifact class.
  ...
  # Generate README.ml-pipelines-sdk.md class for the artifact type on the fly.
  absl.logging.warning(
      ('Could not find matching artifact class for type %r (proto: %r); '
       ...
       'be imported within your container or environment where README.ml-pipelines-sdk.md component '
