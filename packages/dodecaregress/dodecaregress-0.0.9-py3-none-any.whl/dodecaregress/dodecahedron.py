...
class Dodecahedron:
    ...
    def plot(self, solid):
        if solid:
            ...
            center = self.center
            vertex2center_direction = center - vertices
            vertices = vertices + 0.2 * vertex2center_direction

        plot3d(self.vertices, self.face_centerpoints, self.face_axes, self.center[0,0], self.center_axes[0], solid_polys=vertices)
