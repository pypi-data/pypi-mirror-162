...
class TechnosProcessor:
    ...
    def map_techno_lower_to_pretty(df):
        ...
        mapper = pd.read_csv('/Users/donor/PycharmProjects/job-market-pkg/'
                             'src/data_engineering_job_market_package_FelitaD/elt/transform/data/'
                             'technos_lower_to_pretty.csv', sep=';')
