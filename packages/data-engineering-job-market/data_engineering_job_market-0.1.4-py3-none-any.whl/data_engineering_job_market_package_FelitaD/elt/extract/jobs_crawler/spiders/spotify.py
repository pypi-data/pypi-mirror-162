...
from data_engineering_job_market_package_FelitaD.elt.extract.jobs_crawler.items import JobsCrawlerItem
...
if __name__ == '__main__':
    process = CrawlerProcess(
        settings={
            ...
            'ITEM_PIPELINES': {'src.data_engineering_job_market_package_FelitaD.elt.extract.jobs_crawler.pipelines.JobsCrawlerPipeline': 300, },
