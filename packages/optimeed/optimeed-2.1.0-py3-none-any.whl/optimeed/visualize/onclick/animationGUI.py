...
class _AnimationTrace:
    ...
    def __init__(self, elements_list, theTrace):
        ...
        for elements in elements_list:
            self.element_animations.append(self.AnimationElement(elements))
...
class AnimationGUI(QtWidgets.QMainWindow):
    ...
    def add_trace(self, trace_id, element_list, theTrace):
        ...
        :return:
        """
        self.data_animation_traces[trace_id] = _AnimationTrace(self.get_interesting_elements(element_list), theTrace)
