...
class Algorithm(object):
    ...
    def __init__(self,
                 ...
                 evaluator=None,
                 log_frequency=None,
                 convergence=None,  # Added for optimeed
                 **kwargs):
        ...
        self.nfe = 0
        self.convergence = convergence  # Added for optimeed
    ...
    def evaluate_all(self, solutions):
        ...
        theObjectives = [list(solution.objectives) for solution in unevaluated]
        theConstraints = [list(solution.constraints) for solution in unevaluated]
        self.convergence.set_curr_step(theObjectives, theConstraints)
