...
class ContextHandler:
    ...
    def redraw(self):
        if self.theDeviceDrawer is not None:
            ...
            if self.must_rotate:
                rot_y = quaternions.normalize(
                    quaternions.axisangle_to_q((1.0, 0.0, 0.0), -self.tipAngle / 180 * math.pi))
                rot_x = quaternions.normalize(
                    quaternions.axisangle_to_q((0.0, 1.0, 0.0), -self.viewAngle / 180 * math.pi))
