...
class PIH:
                    ...
                    for field_item_obj in field_list.get_list():
                        ...
                        if field_item.name == FIELD_COLLECTION.INDEX.name:
                            ...
                            if modify_data_handler is not None:
                                row_data.append(modify_data_handler(field_item, item))
                            else:
    ...
    class ACTION:
        ...
        class ORION:
            ...
            @staticmethod
            def update_full_name_by_tab_number(full_name: FullName, tab_number: dict) -> bool:
        ...
        def generate_password(once: bool = False, settings: PasswordSettings = None) -> str:
            ...
            while True:  
                ...
                if once or PIH.INPUT.yes_no("Use this password?"):
                    return password
                else:
                    pass
