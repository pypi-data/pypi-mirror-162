...
from pih.collection import CommandLinkItem, CommandChainItem, FieldItem, FieldItemList, CommandItem, LogCommand, ParamItem
...
class FIELD_COLLECTION:
    ...
    class ORION:
        ...
        SIMPLE: FieldItemList = FieldItemList(
        ...
        SIMPLE_TAB_NUMBER: FieldItemList = FieldItemList(
            FieldItem(FIELD_NAME_COLLECTION.TAB_NUMBER, "Tab Number"),
            SIMPLE)

        NAME: FieldItemList = FieldItemList(TAB_NUMBER, FieldItem(
            "pID", "Person ID", False), FieldItem("mID", "Mark ID", False))
