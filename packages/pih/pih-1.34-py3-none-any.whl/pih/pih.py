...
from pih.const import FACADE, EXECUTOR, FIELD_NAME_COLLECTION, LOCAL_COMMAND_LIST_DICT, NAME_POLICY_CONST, FIELD_COLLECTION, PASSWORD, SITE
    ...
    class DATA:
        ...
        class EXTRACT:
            ...
            def tab_number(mark: dict) -> str:
                return PIH.DATA.EXTRACT.parameter(mark, FIELD_NAME_COLLECTION.TAB_NUMBER)

            @staticmethod
            def telephone(user: dict) -> str:
                return PIH.DATA.EXTRACT.parameter(user, FIELD_NAME_COLLECTION.TELEPHONE)

            @staticmethod
            def name(mark: dict) -> str:
                return PIH.DATA.EXTRACT.parameter(mark, FIELD_NAME_COLLECTION.NAME)

            @staticmethod
            def dn(user: dict) -> str:
                return PIH.DATA.EXTRACT.parameter(user, FIELD_NAME_COLLECTION.DN)
            ...
            def description(data: dict) -> str:
                result = PIH.DATA.EXTRACT.parameter(data, FIELD_NAME_COLLECTION.DESCRIPTION)
