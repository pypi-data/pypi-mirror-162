...
from ldj.utils.prop.Properties import Properties
...
class NacosClient:
    ...
    @staticmethod
    def register_service(service_ip, port, service_name, namespaceId, namespace, group):
        NacosClient.get_client().register
