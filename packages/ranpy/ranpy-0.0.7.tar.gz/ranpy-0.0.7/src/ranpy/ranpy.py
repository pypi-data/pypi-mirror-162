...
class Ranpy(object):
    ...
    def fit_CI(self, lb, ub, alpha, dist):
        ...
        loss_fun = lambda params: loss_measure([R.get_dist(dist, params_mapper(params)).ppf(alpha/2),
                                                R.get_dist(dist, params_mapper(params)).ppf(1-alpha/2)])
