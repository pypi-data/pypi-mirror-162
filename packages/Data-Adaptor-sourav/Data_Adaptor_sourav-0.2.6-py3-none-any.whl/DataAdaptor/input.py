...
def upload_file_to_s3(local_file_path,s3_bucket_name):
    """
    Upload File to s3
    """
    try:
        ...
        try:
            ...
            if extension in EXTENSION_LIST:
                ...
                if cloud_name.lower() == 'aws':
                    ...
                    file_path=upload_file_to_s3(local_file_path,self.s3_bucket_name)
                    return file_path
                else:
    ...
    def zip_upload(self, zip_file, cloud_name):
        ...
        try:
            if zipfile.is_zipfile(zip_file):
                ...
                if cloud_name.lower() == 'aws':
                    # checking cloud name
                    file_path=upload_file_to_s3(zip_file,self.s3_bucket_name)
                    return file_path
            ...
            if extension in EXTENSION_LIST:
                ...
                if colud_name.lower() == 'aws':  # checking cloud name
                    ...
                    S3.meta.client.upload_fileobj(
                        url_object, self.s3_bucket_name, INPUT_FILE_FOLDER + file_name)
                        ...
                        if not os.path.exists(tmp_path):
                            ...
                            with open(tmp_path, 'wb') as f:
                                ...
                                if cloud_name.lower() == 'aws':
                                    # checking cloud name
                                    # calling function to save data to s3
                                    s3_file = upload_file_to_s3(tmp_path,self.s3_bucket_name)
