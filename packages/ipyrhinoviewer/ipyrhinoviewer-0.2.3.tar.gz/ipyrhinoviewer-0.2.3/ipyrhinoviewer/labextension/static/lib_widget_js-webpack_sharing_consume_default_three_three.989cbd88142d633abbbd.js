...
class RhinoView extends base_1.DOMWidgetView {
    constructor() {
        ...
        this.base_path = this.model.get('_base_path');
    }
    render() {
        ...
        //Load the file
        load3dmModel(this.scene, '/tree/' + this.base_path + this.path, {
            receiveShadow: true,
            castShadow: true,
        })
            .then(() => {
            ...
            .catch(() => {
            this.showError('Error: path "' + this.base_path + this.path + '" was not found');
            return;
        });
...
//# sourceMappingURL=lib_widget_js-webpack_sharing_consume_default_three_three.989cbd88142d633abbbd.js.map