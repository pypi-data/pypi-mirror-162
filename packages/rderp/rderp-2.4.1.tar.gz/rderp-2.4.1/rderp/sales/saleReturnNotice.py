...
class SaleReturnNotice(ErpClient):
    ...
    def View(self, Number, CreateOrgId=0, Id=""):
        ...
        * create the data for material.View opration
        ...
        data = {
            ...
            "Number": self.Number,
            "Id": self.Id}
        res = ErpClient.View(self, formid="SAL_RETURNNOTICE", data=data)
        return (res)
    ...
    def Save_demo(self, FNumber='API-01', FName='demo-02'):
        ...
        res = ErpClient.Save(self, formid="SAL_RETURNNOTICE", data=data)
        return (res)
    ...
    def Save(self, FBillNo='so-api-002'):
        ...
        app = BillModel(token=self.token, FFormId='SAL_RETURNNOTICE', FActionName='Save')
        data = app.dataGen(FBillNo=self.FBillNo)
        print(data)
        res_str = ErpClient.Save(self, formid="SAL_RETURNNOTICE", data=data)
    ...
    def SaveBatch(self, data_list):
        ...
        *put multiple save format data into a list
        ...
        res = ErpClient.BatchSave(self, formid='SAL_RETURNNOTICE', data=save_data)
        return (res)
    ...
    def SaveBatchAsync(self, data_list):
        ...
        *put multiple save format data into a list
        ...
        self.data_list = data_list
        save_data = {"Model": self.data_list}
        res = ErpClient.BatchSaveQuery(self, formid='SAL_RETURNNOTICE', data=save_data)
        return (res)
    ...
    def Submit(self, FBillNo):
        ...
        * the material Submit operation just after save.
        ...
        res_str = ErpClient.Submit(self, formid="SAL_RETURNNOTICE", data=data)
        res_obj = json.loads(res_str)
        res = res_obj['Result']['ResponseStatus']['IsSuccess']
        return (res)
    ...
    def CancelAssign(self, Numbers=[], CreateOrgId=0, Ids="", NetworkCtrl=""):
        ...
        res = ErpClient.CancelAssign(self, formid="SAL_RETURNNOTICE", data=data)
        return (res)
    ...
    def Audit(self, FBillNo):
        ...
        res_str = ErpClient.Audit(self, formid="SAL_RETURNNOTICE", data=data)
        res_obj = json.loads(res_str)
        res = res_obj['Result']['ResponseStatus']['IsSuccess']
        return (res)
    ...
    def UnAudit(self, FBillNo):
        ...
        res_str = ErpClient.UnAudit(self, formid="SAL_RETURNNOTICE", data=data)
        res_obj = json.loads(res_str)
        res = res_obj['Result']['ResponseStatus']['IsSuccess']
        return (res)
    ...
    def Delete(self, FBillNo):
        ...
        res_str = ErpClient.Delete(self, formid="SAL_RETURNNOTICE", data=data)
        res_obj = json.loads(res_str)
        res = res_obj['Result']['ResponseStatus']['IsSuccess']
        return (res)
    def Push(self,FBillNo):
        ...
        res_str = ErpClient.Push(self,formid="SAL_RETURNNOTICE",data=data)
        res_obj = json.loads(res_str)
        # print(res_obj)
        res = {}
    ...
    def Allocate(self, PrdIdString=0, OrgIdString=""):
        ...
        * print(data6)
        ...
        res = ErpClient.Allocate(self, formid="SAL_RETURNNOTICE", data=data)
        return (res)
    ...
    def CancelAllocate(self, PrdIdString=0, OrgIdString=""):
        ...
        res = ErpClient.CancelAllocate(self, formid="SAL_RETURNNOTICE", data=data)
        return (res)
    ...
    def ExcuteOperation(self, opNumber="Forbid", Numbers=[], CreateOrgId=0, Ids="", PkEntryIds=[], NetworkCtrl="",
        ...
        res = ErpClient.ExcuteOperation(self, formid="SAL_RETURNNOTICE", opNumber=self.opNumber, data=data)
        return (res)
