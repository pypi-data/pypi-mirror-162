...
class test_sd_contact :
    ...
    def __init__(self, sample1, sample2, ngrid, s, resampling, b1 = None, b2 = None, nboot = 200, c = 0.75) :
...
class test_sd_SR :
    ...
    def __init__(self, sample1, sample2, ngrid, s, resampling, b1 = None, b2 = None, nboot = 200, a = 0.1, eta = 10**(-6)):
...
class test_sd_NDM :
    ...
    def __init__(self, sample1, sample2, ngrid, s, resampling, b1 = None, b2 = None, nboot = 200, epsilon = None, form = "KS"):
