...
def _perform_notebook_replacements(
    ...
    # - Load schema from file
        ...
        nb = _replace_in_notebook_source_code(
            "schema = get_pod_schema(pod_identifier)",
            "from bitfount import BitfountSchema\nschema = BitfountSchema."
            "load_from_file('../tests/integration/resources/schemas/data-schema-segmentation-data-demo.yaml')\n"  # noqa: B950
...
class TestTutorials:
    ...
    def cleanup(self) -> Generator[None, None, None]:
        ...
        try:
            ...
            if Path("tutorials/segmentation").exists():
                rm_tree(Path("tutorials/segmentation"))
            ...
            Path("tutorials/MyCustomSegmentationModel.py").unlink(missing_ok=True)
    ...
    def test_tutorial_12(
        ...
        assert Path("tutorials/part_12_model.pt").exists()
