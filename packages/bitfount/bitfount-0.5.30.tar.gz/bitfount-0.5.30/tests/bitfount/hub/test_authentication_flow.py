...
class TestBitfountSession:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("https://am.bitfount.com", False),
            ("http://hub.bitfount.com", False),  # HTTP is not allowed
        ],
    )
    def test_is_hub_url(
        self, bitfount_session: BitfountSession, url: str, expected_output: bool
    ) -> None:
    ...
    @pytest.mark.parametrize(
        "url, expected_output",
        [
            ("https://am.bitfount.com", True),
            ("https://am.bitfount.com/api/blah", True),
            ("https://am.staging.bitfount.com", True),
            ("https://hub.bitfount.com", False),
            ("http://am.bitfount.com", False),  # HTTP is not allowed
        ],
    )
    def test_is_am_url(
        self, bitfount_session: BitfountSession, url: str, expected_output: bool
