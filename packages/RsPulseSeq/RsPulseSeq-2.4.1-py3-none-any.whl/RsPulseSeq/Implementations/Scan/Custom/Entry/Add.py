...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.scan.custom.entry.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'SCAN:CUSTom:ENTRy:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: SCAN:CUSTom:ENTRy:ADD \n
		Snippet: driver.scan.custom.entry.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'SCAN:CUSTom:ENTRy:ADD', opc_timeout_ms)
