...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.ipm.listPy.item.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'IPM:LIST:ITEM:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: IPM:LIST:ITEM:ADD \n
		Snippet: driver.ipm.listPy.item.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'IPM:LIST:ITEM:ADD', opc_timeout_ms)
