...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.assignment.generator.path.emitter.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'ASSignment:GENerator:PATH:EMITter:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: ASSignment:GENerator:PATH:EMITter:ADD \n
		Snippet: driver.assignment.generator.path.emitter.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'ASSignment:GENerator:PATH:EMITter:ADD', opc_timeout_ms)
