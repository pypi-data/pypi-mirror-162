...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.emitter.mode.beam.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'EMITter:MODE:BEAM:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: EMITter:MODE:BEAM:ADD \n
		Snippet: driver.emitter.mode.beam.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'EMITter:MODE:BEAM:ADD', opc_timeout_ms)
