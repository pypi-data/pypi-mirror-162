...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.platform.emitter.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'PLATform:EMITter:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: PLATform:EMITter:ADD \n
		Snippet: driver.platform.emitter.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'PLATform:EMITter:ADD', opc_timeout_ms)
