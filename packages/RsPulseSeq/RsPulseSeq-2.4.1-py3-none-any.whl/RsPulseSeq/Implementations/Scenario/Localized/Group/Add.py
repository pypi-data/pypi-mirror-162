...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.scenario.localized.group.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'SCENario:LOCalized:GROup:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: SCENario:LOCalized:GROup:ADD \n
		Snippet: driver.scenario.localized.group.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'SCENario:LOCalized:GROup:ADD', opc_timeout_ms)
