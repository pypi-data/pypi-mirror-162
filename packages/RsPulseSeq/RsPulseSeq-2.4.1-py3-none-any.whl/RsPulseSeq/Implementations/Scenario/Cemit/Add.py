...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.scenario.cemit.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'SCENario:CEMit:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: SCENario:CEMit:ADD \n
		Snippet: driver.scenario.cemit.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'SCENario:CEMit:ADD', opc_timeout_ms)
