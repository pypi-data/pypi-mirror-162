...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.sequence.item.ipm.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'SEQuence:ITEM:IPM:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: SEQuence:ITEM:IPM:ADD \n
		Snippet: driver.sequence.item.ipm.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'SEQuence:ITEM:IPM:ADD', opc_timeout_ms)
