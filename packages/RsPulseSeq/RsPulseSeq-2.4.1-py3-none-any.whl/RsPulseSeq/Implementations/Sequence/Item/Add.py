...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.sequence.item.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'SEQuence:ITEM:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: SEQuence:ITEM:ADD \n
		Snippet: driver.sequence.item.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'SEQuence:ITEM:ADD', opc_timeout_ms)
