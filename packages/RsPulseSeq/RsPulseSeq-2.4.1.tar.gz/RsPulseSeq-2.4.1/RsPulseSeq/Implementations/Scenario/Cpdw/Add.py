...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.scenario.cpdw.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'SCENario:CPDW:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: SCENario:CPDW:ADD \n
		Snippet: driver.scenario.cpdw.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'SCENario:CPDW:ADD', opc_timeout_ms)
