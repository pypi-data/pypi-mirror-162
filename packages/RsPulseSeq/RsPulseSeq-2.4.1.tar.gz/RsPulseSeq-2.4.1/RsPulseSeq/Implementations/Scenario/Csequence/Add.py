...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.scenario.csequence.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'SCENario:CSEQuence:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: SCENario:CSEQuence:ADD \n
		Snippet: driver.scenario.csequence.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'SCENario:CSEQuence:ADD', opc_timeout_ms)
