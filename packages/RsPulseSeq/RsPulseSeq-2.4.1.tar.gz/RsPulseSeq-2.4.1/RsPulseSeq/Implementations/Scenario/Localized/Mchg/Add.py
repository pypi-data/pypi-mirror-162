...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.scenario.localized.mchg.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'SCENario:LOCalized:MCHG:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: SCENario:LOCalized:MCHG:ADD \n
		Snippet: driver.scenario.localized.mchg.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'SCENario:LOCalized:MCHG:ADD', opc_timeout_ms)
