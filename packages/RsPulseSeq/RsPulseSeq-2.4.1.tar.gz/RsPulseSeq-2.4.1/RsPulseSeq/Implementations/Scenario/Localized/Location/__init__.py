...
class Location:
	...
	def rec(self):
		...
		if not hasattr(self, '_rec'):
			from .Rec import Rec
			self._rec = Rec(self._core, self._cmd_group)
		return self._rec
	...
	def get_altitude(self) -> float:
		...
		Snippet: value: float = driver.scenario.localized.location.get_altitude() \n
		Sets the altitude of the antenna. \n
			:return: altitude: float Range: -1e+09 to 1e+09
		"""
		response = self._core.io.query_str('SCENario:LOCalized:LOCation:ALTitude?')
		return Conversions.str_to_float(response)

	def set_altitude(self, altitude: float) -> None:
		"""SCPI: SCENario:LOCalized:LOCation:ALTitude \n
		Snippet: driver.scenario.localized.location.set_altitude(altitude = 1.0) \n
		Sets the altitude of the antenna. \n
			:param altitude: float Range: -1e+09 to 1e+09
		"""
		param = Conversions.decimal_value_to_str(altitude)
		self._core.io.write(f'SCENario:LOCalized:LOCation:ALTitude {param}')

	def get_azimuth(self) -> float:
		"""SCPI: SCENario:LOCalized:LOCation:AZIMuth \n
		Snippet: value: float = driver.scenario.localized.location.get_azimuth() \n
		Sets the azimuth. \n
			:return: azimuth: float Range: 0 to 360
		"""
		response = self._core.io.query_str('SCENario:LOCalized:LOCation:AZIMuth?')
		return Conversions.str_to_float(response)

	def set_azimuth(self, azimuth: float) -> None:
		"""SCPI: SCENario:LOCalized:LOCation:AZIMuth \n
		Snippet: driver.scenario.localized.location.set_azimuth(azimuth = 1.0) \n
		Sets the azimuth. \n
			:param azimuth: float Range: 0 to 360
		"""
		param = Conversions.decimal_value_to_str(azimuth)
		self._core.io.write(f'SCENario:LOCalized:LOCation:AZIMuth {param}')

	def get_east(self) -> float:
		"""SCPI: SCENario:LOCalized:LOCation:EAST \n
		Snippet: value: float = driver.scenario.localized.location.get_east() \n
		Sets the emitter coordinates. \n
			:return: east: No help available
		"""
		response = self._core.io.query_str('SCENario:LOCalized:LOCation:EAST?')
		return Conversions.str_to_float(response)

	def set_east(self, east: float) -> None:
		"""SCPI: SCENario:LOCalized:LOCation:EAST \n
		Snippet: driver.scenario.localized.location.set_east(east = 1.0) \n
		Sets the emitter coordinates. \n
			:param east: float Range: -1e+09 to 1e+09, Unit: m
		"""
		param = Conversions.decimal_value_to_str(east)
		self._core.io.write(f'SCENario:LOCalized:LOCation:EAST {param}')

	def get_elevation(self) -> float:
		"""SCPI: SCENario:LOCalized:LOCation:ELEVation \n
		Snippet: value: float = driver.scenario.localized.location.get_elevation() \n
		Sets the elevation. \n
			:return: elevation: float Range: -90 to 90
		"""
		response = self._core.io.query_str('SCENario:LOCalized:LOCation:ELEVation?')
		return Conversions.str_to_float(response)

	def set_elevation(self, elevation: float) -> None:
		"""SCPI: SCENario:LOCalized:LOCation:ELEVation \n
		Snippet: driver.scenario.localized.location.set_elevation(elevation = 1.0) \n
		Sets the elevation. \n
			:param elevation: float Range: -90 to 90
		"""
		param = Conversions.decimal_value_to_str(elevation)
		self._core.io.write(f'SCENario:LOCalized:LOCation:ELEVation {param}')

	def get_height(self) -> float:
		"""SCPI: SCENario:LOCalized:LOCation:HEIGht \n
		Snippet: value: float = driver.scenario.localized.location.get_height() \n
		Sets the height of the antenna. \n
			:return: height: float Range: -1e+09 to 1e+09
		"""
		response = self._core.io.query_str('SCENario:LOCalized:LOCation:HEIGht?')
		return Conversions.str_to_float(response)

	def set_height(self, height: float) -> None:
		"""SCPI: SCENario:LOCalized:LOCation:HEIGht \n
		Snippet: driver.scenario.localized.location.set_height(height = 1.0) \n
		Sets the height of the antenna. \n
			:param height: float Range: -1e+09 to 1e+09
		"""
		param = Conversions.decimal_value_to_str(height)
		self._core.io.write(f'SCENario:LOCalized:LOCation:HEIGht {param}')

	def get_latitude(self) -> float:
		"""SCPI: SCENario:LOCalized:LOCation:LATitude \n
		Snippet: value: float = driver.scenario.localized.location.get_latitude() \n
		Use for defining the position of a fixed emitter (no movement) on a georeferenced map. Positive values represent °East.
		Negative values represent °West. \n
			:return: latitude: No help available
		"""
		response = self._core.io.query_str('SCENario:LOCalized:LOCation:LATitude?')
		return Conversions.str_to_float(response)

	def set_latitude(self, latitude: float) -> None:
		"""SCPI: SCENario:LOCalized:LOCation:LATitude \n
		Snippet: driver.scenario.localized.location.set_latitude(latitude = 1.0) \n
		Use for defining the position of a fixed emitter (no movement) on a georeferenced map. Positive values represent °East.
		Negative values represent °West. \n
			:param latitude: float Range: -180 to 180
		"""
		param = Conversions.decimal_value_to_str(latitude)
		self._core.io.write(f'SCENario:LOCalized:LOCation:LATitude {param}')

	def get_longitude(self) -> float:
		"""SCPI: SCENario:LOCalized:LOCation:LONGitude \n
		Snippet: value: float = driver.scenario.localized.location.get_longitude() \n
		Use for defining the position of a fixed emitter (no movement) on a georeferenced map. Positive values represent °East.
		Negative values represent °West. \n
			:return: longitude: float Range: -180 to 180
		"""
		response = self._core.io.query_str('SCENario:LOCalized:LOCation:LONGitude?')
		return Conversions.str_to_float(response)

	def set_longitude(self, longitude: float) -> None:
		"""SCPI: SCENario:LOCalized:LOCation:LONGitude \n
		Snippet: driver.scenario.localized.location.set_longitude(longitude = 1.0) \n
		Use for defining the position of a fixed emitter (no movement) on a georeferenced map. Positive values represent °East.
		Negative values represent °West. \n
			:param longitude: float Range: -180 to 180
		"""
		param = Conversions.decimal_value_to_str(longitude)
		self._core.io.write(f'SCENario:LOCalized:LOCation:LONGitude {param}')

	def get_north(self) -> float:
		"""SCPI: SCENario:LOCalized:LOCation:NORTh \n
		Snippet: value: float = driver.scenario.localized.location.get_north() \n
		Sets the emitter coordinates. \n
			:return: north: float Range: -1e+09 to 1e+09, Unit: m
		"""
		response = self._core.io.query_str('SCENario:LOCalized:LOCation:NORTh?')
		return Conversions.str_to_float(response)

	def set_north(self, north: float) -> None:
		"""SCPI: SCENario:LOCalized:LOCation:NORTh \n
		Snippet: driver.scenario.localized.location.set_north(north = 1.0) \n
		Sets the emitter coordinates. \n
			:param north: float Range: -1e+09 to 1e+09, Unit: m
		"""
		param = Conversions.decimal_value_to_str(north)
		self._core.io.write(f'SCENario:LOCalized:LOCation:NORTh {param}')

	# noinspection PyTypeChecker
	def get_pmode(self) -> enums.PmodeLocation:
		"""SCPI: SCENario:LOCalized:LOCation:PMODe \n
		Snippet: value: enums.PmodeLocation = driver.scenario.localized.location.get_pmode() \n
		Sets if the emitter is static or moving. \n
			:return: pmode: STATic| STEPs| MOVing
		"""
		response = self._core.io.query_str('SCENario:LOCalized:LOCation:PMODe?')
		return Conversions.str_to_scalar_enum(response, enums.PmodeLocation)

	def set_pmode(self, pmode: enums.PmodeLocation) -> None:
		"""SCPI: SCENario:LOCalized:LOCation:PMODe \n
		Snippet: driver.scenario.localized.location.set_pmode(pmode = enums.PmodeLocation.MOVing) \n
		Sets if the emitter is static or moving. \n
			:param pmode: STATic| STEPs| MOVing
		"""
		param = Conversions.enum_scalar_to_str(pmode, enums.PmodeLocation)
		self._core.io.write(f'SCENario:LOCalized:LOCation:PMODe {param}')
