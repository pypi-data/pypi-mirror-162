...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.scenario.df.location.pstep.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'SCENario:DF:LOCation:PSTep:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: SCENario:DF:LOCation:PSTep:ADD \n
		Snippet: driver.scenario.df.location.pstep.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'SCENario:DF:LOCation:PSTep:ADD', opc_timeout_ms)
