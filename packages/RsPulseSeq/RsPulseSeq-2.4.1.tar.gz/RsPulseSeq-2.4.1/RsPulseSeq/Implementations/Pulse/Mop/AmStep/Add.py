...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.pulse.mop.amStep.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'PULSe:MOP:AMSTep:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: PULSe:MOP:AMSTep:ADD \n
		Snippet: driver.pulse.mop.amStep.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'PULSe:MOP:AMSTep:ADD', opc_timeout_ms)
