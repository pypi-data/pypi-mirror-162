...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.pulse.mop.cchirp.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'PULSe:MOP:CCHirp:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: PULSe:MOP:CCHirp:ADD \n
		Snippet: driver.pulse.mop.cchirp.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'PULSe:MOP:CCHirp:ADD', opc_timeout_ms)
