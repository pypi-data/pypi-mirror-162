...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.pulse.mop.fmStep.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'PULSe:MOP:FMSTep:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: PULSe:MOP:FMSTep:ADD \n
		Snippet: driver.pulse.mop.fmStep.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'PULSe:MOP:FMSTep:ADD', opc_timeout_ms)
