...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.pulse.mop.piecewise.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'PULSe:MOP:PIECewise:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: PULSe:MOP:PIECewise:ADD \n
		Snippet: driver.pulse.mop.piecewise.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'PULSe:MOP:PIECewise:ADD', opc_timeout_ms)
