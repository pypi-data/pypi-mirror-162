...
class End:
	...
	def set(self) -> None:
		...
		Snippet: driver.importPy.view.move.end.set() \n
		Goes to the first/next/previous/last page. \n
		"""
		self._core.io.write(f'IMPort:VIEW:MOVE:END')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: IMPort:VIEW:MOVE:END \n
		Snippet: driver.importPy.view.move.end.set_with_opc() \n
		Goes to the first/next/previous/last page. \n
		...
		self._core.io.write_with_opc(f'IMPort:VIEW:MOVE:END', opc_timeout_ms)
