...
class Add:
	...
	def set(self) -> None:
		"""SCPI: DSRC:ITEM:ADD \n
		Snippet: driver.dsrc.item.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'DSRC:ITEM:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: DSRC:ITEM:ADD \n
		Snippet: driver.dsrc.item.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'DSRC:ITEM:ADD', opc_timeout_ms)
