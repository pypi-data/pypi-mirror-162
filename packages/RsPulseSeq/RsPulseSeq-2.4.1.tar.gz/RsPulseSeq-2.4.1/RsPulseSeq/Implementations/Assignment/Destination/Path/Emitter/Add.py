...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.assignment.destination.path.emitter.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'ASSignment:DESTination:PATH:EMITter:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: ASSignment:DESTination:PATH:EMITter:ADD \n
		Snippet: driver.assignment.destination.path.emitter.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'ASSignment:DESTination:PATH:EMITter:ADD', opc_timeout_ms)
