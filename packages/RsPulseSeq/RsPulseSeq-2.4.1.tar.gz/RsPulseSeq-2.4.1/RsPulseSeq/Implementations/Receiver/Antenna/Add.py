...
class Add:
	...
	def set(self) -> None:
		...
		Snippet: driver.receiver.antenna.add.set() \n
		Appends new item. \n
		"""
		self._core.io.write(f'RECeiver:ANTenna:ADD')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: RECeiver:ANTenna:ADD \n
		Snippet: driver.receiver.antenna.add.set_with_opc() \n
		Appends new item. \n
		...
		self._core.io.write_with_opc(f'RECeiver:ANTenna:ADD', opc_timeout_ms)
