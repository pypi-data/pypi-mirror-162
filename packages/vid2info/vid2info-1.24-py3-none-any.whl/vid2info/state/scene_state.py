...
from vid2info.state.config import DEFAULT_ELEMENT_STATE_CLASS

from time import time
import numpy as np
from vid2info.inference.utils import crop_bbox_from_image
from vid2info.inference.config import BBOX_XYXY, SEGMENTATION_MASK
...
class SceneState:
    def __init__(self, tracker_out : dict, get_first_element_time_stamp: callable = lambda track_id : None,
                 ...
                 save_full_segmentation_mask : bool = False, element_state_class : type = DEFAULT_ELEMENT_STATE_CLASS):
        """
