import requests
from annotell.auth.requests.auth_session import RequestsAuthSession, DEFAULT_HOST as DEFAULT_AUTH_HOST
...
class ExportApiClient:
    ...
    def __init__(self, *,
        ...
        self.host = host
        self.auth_session = RequestsAuthSession(host=auth_host, auth=auth)
        self.headers = {
    ...
    def session(self) -> requests.Session:
        return self.auth_session.session
