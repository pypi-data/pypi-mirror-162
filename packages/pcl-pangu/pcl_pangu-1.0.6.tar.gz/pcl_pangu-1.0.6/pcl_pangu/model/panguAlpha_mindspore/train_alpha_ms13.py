...
from src.utils_pangu import download_data, ckpt_tar_openi, ckpt_copy_tar_new, get_ckpt_file_list
...
def load_train_net(args_opt):
    ...
    if args_opt.incremental_training:
        load_ckpt_local_path = args_opt.load_ckpt_local_path
    else:
    ...
    config = PANGUALPHAConfig(
        ...
        load_ckpt_path=load_ckpt_local_path,
...
def restore_filtered_ckpt_from_obs_incremental_training(args_opt, model):
    ...
    if args_opt.incremental_training:
        ...
        if rank % 8 == 0:
            ...
            OneCKPTPath = ckpt_tar_openi(args_opt.load_ckpt_local_path)
