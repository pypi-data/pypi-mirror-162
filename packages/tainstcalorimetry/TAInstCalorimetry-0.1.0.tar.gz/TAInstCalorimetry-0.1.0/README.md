...
Import of **TAInstCalorimetry**.

```python
# import
from TAInstCalorimetry import ta_calorimetry
```
...
tam = ta_calorimetry.Measurement(folder=path_to_data)
