...
# Licence : MIT
"""Client interface calls several sub-system of Kami-lib light
"""
from typing import Union

from kami_light.parser import (parser_text)
from kami_light.preprocessing.transformation import (RemoveDigits,
                                                     ToLowerCase,
                                                     ToUpperCase,
                                                     RemovePunctuation,
                                                     RemoveDiacritics,
