...
class MLOps(MLTrigger):
    ...
    def drawup_dataset(self, name:str):
        ...
        logger['mlops'].info(f'The {name} dataset is not yet selected in mlops object!')
        return dataset.copy()
    ...
    def drawup_model(self, name:str):
        ...
        logger['mlops'].info(f'The {self._model_name} model is not yet selected in mlops object!')
