...
class MLOps(MLTrigger):
    ...
    def codecommit(self, entry_points, upload=True):
        ...
        self.__dataset = self.preprocessing(entry_point=entry_point_obj.mlops_entry_point)
        self.__model = self.learning(entry_point=entry_point_obj.mlops_entry_point)             # mlops.entry_point.train
