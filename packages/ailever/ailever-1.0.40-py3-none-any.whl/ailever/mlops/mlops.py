...
class MLOps(MLTrigger):
    ...
    def codecommit(self, entry_points, upload=True):
        ...
        self.__dataset = self.preprocessing(entry_points=self.mlops_entry_points)
        self.__model = self.learning(entry_points=self.mlops_entry_points)             # mlops.entry_point.train
