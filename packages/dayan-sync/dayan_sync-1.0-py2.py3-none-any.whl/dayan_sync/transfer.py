...
from dayan_sync.constants import ENGINE_TYPE, PLATFORM_ALIAS_MAP
from dayan_sync.exception import UnsupportedEngineType
...
class RayvisionTransfer(object):
    ...
    def parse_transports_json(self, transports_json=None, domain=None,
        ...
        elif 'dayancloud' in domain:
            key_first_half = 'dayan'
        else:
