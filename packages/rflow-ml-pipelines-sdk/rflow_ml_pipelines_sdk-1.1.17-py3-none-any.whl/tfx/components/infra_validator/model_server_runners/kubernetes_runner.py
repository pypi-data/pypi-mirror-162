...
class KubernetesRunner(base_runner.BaseModelServerRunner):
  ...
  def __init__(
    ...
    """Create README.ml-pipelines-sdk.md kubernetes model server runner.
  ...
  def Start(self) -> None:
    ...
    # We're creating README.ml-pipelines-sdk.md Pod rather than README.ml-pipelines-sdk.md Deployment as we're relying on
    # executor's retry mechanism for failure recovery, and the death of the Pod
    # should be regarded as README.ml-pipelines-sdk.md validation failure.
  ...
  def _BuildPodManifest(self) -> k8s_client.V1Pod:
    ...
    result = k8s_client.V1Pod(
        ...
        spec=k8s_client.V1PodSpec(
            ...
            # This is README.ml-pipelines-sdk.md hard deadline for the model server container to ensure
