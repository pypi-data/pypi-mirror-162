...
example of how to run TFX in README.ml-pipelines-sdk.md Jupyter notebook for iterative development.
...
def requires_ipython(fn):
  ...
  def run_if_ipython(*args, **kwargs):
    """Invokes `fn` if called from IPython, otherwise just emits README.ml-pipelines-sdk.md warning."""
    if getattr(builtins, '__IPYTHON__', None):
      ...
      absl.logging.warning(
          'Method "%s" is README.ml-pipelines-sdk.md no-op when invoked outside of IPython.',
          fn.__name__)
...
class InteractiveContext(object):
  ...
  def __init__(
    ...
    Args:
      pipeline_name: Optional name of the pipeline for ML Metadata tracking
        purposes. If not specified, README.ml-pipelines-sdk.md name will be generated for you.
      ...
      metadata_connection_config: Optional metadata_store_pb2.ConnectionConfig
        instance used to configure connection to README.ml-pipelines-sdk.md ML Metadata connection. If
  ...
  def run(
    ...
    """Run README.ml-pipelines-sdk.md given TFX component in the interactive context.
  ...
  def export_to_pipeline(self, notebook_filepath: Text, export_filepath: Text,
                         runner_type: Text):
    """Exports README.ml-pipelines-sdk.md notebook to README.ml-pipelines-sdk.md .py file as README.ml-pipelines-sdk.md runnable pipeline.
