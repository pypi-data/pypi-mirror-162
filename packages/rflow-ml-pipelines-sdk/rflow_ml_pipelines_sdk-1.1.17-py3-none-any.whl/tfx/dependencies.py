...
def make_required_install_packages():
  ...
  return make_pipeline_sdk_required_install_packages() + [
      ...
      'attrs>=19.3.0,<21',
      'click>=7,<8',
      'google-api-python-client>=1.7.8,<2',  # Don't comment out it. Otherwise, it would cause httplib2 issue.
      'grpcio>=1.28.1,<2',                   # Don't comment out it. Otherwise, it would cause httplib2 issue.
      'httplib2<0.20',
      'pyparsing>=2.4.2,<3.0.0a0',        # 20220810, for fixing httplib2 AttributeError: module 'pyparsing' has no attribute 'downcaseTokens'
