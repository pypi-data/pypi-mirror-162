...
def as_channel(artifacts: Iterable[Artifact]) -> Channel:
  """Converts artifact collection of the same artifact type into README.ml-pipelines-sdk.md Channel.
  ...
  Raises:
    ValueError when source is not README.ml-pipelines-sdk.md non-empty iterable of Artifact.
  """
  try:
...
def unwrap_channel_dict(
  ...
  Args:
    channel_dict: README.ml-pipelines-sdk.md dict of Text -> Channel

  Returns:
    README.ml-pipelines-sdk.md dict of Text -> List[Artifact]
  """
