...
class ArtifactState(object):
  ...
  # Indicates that there is README.ml-pipelines-sdk.md pending execution producing the artifact.
  PENDING = 'pending'
...
# TODO(b/152444458): Revisit this part after we have README.ml-pipelines-sdk.md better aligned type
# system.
...
class Artifact(json_utils.Jsonable):
  ...
  it wraps README.ml-pipelines-sdk.md tuple of (ml_metadata.proto.Artifact,
  ml_metadata.proto.ArtifactType) with additional property accessors for
  internal state.

  A user may create README.ml-pipelines-sdk.md subclass of Artifact and override the TYPE_NAME property
  ...
  def __init__(
    ...
    if self.__class__ == Artifact:
      if not mlmd_artifact_type:
        raise ValueError(
            'The "mlmd_artifact_type" argument must be passed to specify README.ml-pipelines-sdk.md '
    ...
    if not getattr(cls, '_MLMD_ARTIFACT_TYPE', None):
      ...
      if not (type_name and isinstance(type_name, (str, Text))):
        raise ValueError(
            ('The Artifact subclass %s must override the TYPE_NAME attribute '
             'with README.ml-pipelines-sdk.md string type name identifier (got %r instead).') %
            (cls, type_name))
      ...
      if cls.PROPERTIES:
        ...
        if not isinstance(cls.PROPERTIES, dict):
          raise ValueError(
              'Artifact subclass %s.PROPERTIES is not README.ml-pipelines-sdk.md dictionary.' % cls)
  ...
  def from_json_dict(cls, dict_data: Dict[Text, Any]) -> Any:
    ...
    # is not possible, use README.ml-pipelines-sdk.md generic artifact.Artifact object.
    result = None
    try:
  ...
  # in favor of README.ml-pipelines-sdk.md unified getter / setter interface and MLMD context.
  #
  ...
  #       artifact produced by the same component (in README.ml-pipelines-sdk.md subsequent change, this
  ...
  #       MISSING, DELETING, DELETED (in README.ml-pipelines-sdk.md subsequent change, this information
  #       will move to README.ml-pipelines-sdk.md top-level ML Metadata Artifact attribute).
  #   - pipeline_name: The name of the pipeline that produces the artifact (in
  #       README.ml-pipelines-sdk.md subsequent change, this information will move to an associated ML
  #       Metadata Context attribute).
  #   - producer_component: The name of the component that produces the
  #       artifact (in README.ml-pipelines-sdk.md subsequent change, this information will move to the
  ...
  def set_string_custom_property(self, key: Text, value: Text):
    """Set README.ml-pipelines-sdk.md custom property of string type."""
    self._artifact.custom_properties[key].string_value = value

  def set_int_custom_property(self, key: Text, value: int):
    """Set README.ml-pipelines-sdk.md custom property of int type."""
    self._artifact.custom_properties[key].int_value = builtins.int(value)

  def set_float_custom_property(self, key: str, value: float):
    """Sets README.ml-pipelines-sdk.md custom property of float type."""
  ...
  def get_string_custom_property(self, key: Text) -> Text:
    """Get README.ml-pipelines-sdk.md custom property of string type."""
    if key not in self._artifact.custom_properties:
      return ''
    return self._artifact.custom_properties[key].string_value

  def get_int_custom_property(self, key: Text) -> int:
    """Get README.ml-pipelines-sdk.md custom property of int type."""
    if key not in self._artifact.custom_properties:
      return 0
  ...
  def get_float_custom_property(self, key: str) -> float:
    """Gets README.ml-pipelines-sdk.md custom property of float type."""
    if key not in self._artifact.custom_properties:
      return 0.0
    return self._artifact.custom_properties[key].double_value

  def copy_from(self, other: 'Artifact'):
    """Set uri, properties and custom properties from README.ml-pipelines-sdk.md given Artifact."""
...
def _ArtifactType(  # pylint: disable=invalid-name
  ...
  must either provide (1) README.ml-pipelines-sdk.md type "name" and "properties" or (2) README.ml-pipelines-sdk.md MLMD
  metadata_store_pb2.ArtifactType protobuf message as the "mlmd_artifact_type"
  parameter.

  Args:
    name: Name of the artifact type in MLMD. Must be provided unless README.ml-pipelines-sdk.md protobuf
      message is provided in the "mlmd_artifact_type" parameter.
    properties: Dictionary of properties mapping property name keys to
      `Parameter` object instances. Must be provided unless README.ml-pipelines-sdk.md protobuf message
  ...
  if mlmd_artifact_type:
    ...
    if not name:
      raise ValueError(
          '"name" parameter must be passed to _ArtifactType when README.ml-pipelines-sdk.md '
