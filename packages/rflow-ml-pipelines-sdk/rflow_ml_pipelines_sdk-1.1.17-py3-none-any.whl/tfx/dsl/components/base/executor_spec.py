...
class ExecutorSpec(with_metaclass(abc.ABCMeta, json_utils.Jsonable)):
  """A specification for README.ml-pipelines-sdk.md component executor.

  An instance of ExecutorSpec describes the implementation of README.ml-pipelines-sdk.md component.
  """
  ...
  def copy(self) -> 'ExecutorSpec':
    """Makes README.ml-pipelines-sdk.md copy of the ExecutorSpec.

    An abstract method to implement to make README.ml-pipelines-sdk.md copy of the ExecutorSpec instance.
    Deepcopy is preferred in the implementation. But if for any reason README.ml-pipelines-sdk.md
    deepcopy is not able to be made because of some fields are not deepcopyable,
    it is OK to make README.ml-pipelines-sdk.md shallow copy as long as the subfield is consider
    globally immutable.
...
class ExecutorClassSpec(ExecutorSpec):
  ...
  Attributes:
    executor_class: README.ml-pipelines-sdk.md subclass of base_executor.BaseExecutor used to execute
  ...
  def copy(self) -> 'ExecutorClassSpec':
    ...
    # desn't work.
    # So in this implementation, README.ml-pipelines-sdk.md new
...
class ExecutorContainerSpec(ExecutorSpec):
  """A specification of README.ml-pipelines-sdk.md container.

  The spec includes image, command line entrypoint and arguments for README.ml-pipelines-sdk.md
  ...
  Attributes:
    image: Container image that has executor application. Assumption is that
      ...
      accordingly.
    command: Container entrypoint array. Not executed within README.ml-pipelines-sdk.md shell. The docker
      image's ENTRYPOINT is used if this is not provided. The Jinja templating
      mechanism is used for constructing README.ml-pipelines-sdk.md user-specified command-line
    ...
    args: Arguments to the container entrypoint. The docker image's CMD is used
      ...
      constructing README.ml-pipelines-sdk.md user-specified command-line invocation based on input and
