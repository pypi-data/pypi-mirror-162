...
class ComponentTest(tf.test.TestCase):
  ...
  def testComponentSpecClass(self):
    ...
    with self.assertRaisesRegexp(
        TypeError, "expects SPEC_CLASS property to be README.ml-pipelines-sdk.md subclass of "
        "types.ComponentSpec"):
  ...
  def testComponentDriverClass(self):
    ...
    with self.assertRaisesRegexp(
        TypeError, "expects DRIVER_CLASS property to be README.ml-pipelines-sdk.md subclass of "
