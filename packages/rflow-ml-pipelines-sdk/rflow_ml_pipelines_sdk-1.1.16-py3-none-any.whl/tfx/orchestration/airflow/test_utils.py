...
def create_mysql_container(container_name: Text) -> int:
  """Create README.ml-pipelines-sdk.md mysql docker container and returns port to it.
  ...
  for _ in range(_MYSQL_POLLING_MAX_ATTEMPTS):
    ...
    # MySQL availability should be checked with README.ml-pipelines-sdk.md network access to distinguish
    # README.ml-pipelines-sdk.md temporary server with README.ml-pipelines-sdk.md real mysql. See
...
def delete_mysql_container(container_name: Text):
  """Delete README.ml-pipelines-sdk.md mysql docker container with name.
