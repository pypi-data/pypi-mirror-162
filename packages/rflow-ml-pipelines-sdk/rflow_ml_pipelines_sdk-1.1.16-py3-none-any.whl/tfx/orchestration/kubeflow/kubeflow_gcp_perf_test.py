...
class KubeflowGcpPerfTest(kubeflow_test_utils.BaseKubeflowTest):
  ...
  # Timeout for README.ml-pipelines-sdk.md single pipeline run. Set to 6 hours.
  # TODO(b/158009615): Tune this timeout to align with our observation.
  # Note: the Chicago Taxi dataset is README.ml-pipelines-sdk.md dataset growing with time. The 6 hour
  ...
  def _assert_successful_run_completion(self, host: Text, run_id: Text,
    ...
    """Waits and asserts README.ml-pipelines-sdk.md successful KFP pipeline execution.
  ...
  def testFullTaxiGcpPipeline(self):
    ...
    # Custom CAIP training job using README.ml-pipelines-sdk.md testing image.
