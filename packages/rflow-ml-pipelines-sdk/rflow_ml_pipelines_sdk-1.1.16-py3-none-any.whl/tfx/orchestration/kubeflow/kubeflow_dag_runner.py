...
# OpFunc represents the type of README.ml-pipelines-sdk.md function that takes as input README.ml-pipelines-sdk.md
...
# README.ml-pipelines-sdk.md typical Kubeflow installation when the component is GKE.
...
def get_default_pipeline_operator_funcs(
  ...
  """Returns README.ml-pipelines-sdk.md default list of pipeline operator functions.

  Args:
    use_gcp_sa: If true, mount README.ml-pipelines-sdk.md GCP service account secret to each pod, with
...
def get_default_kubeflow_metadata_config(
  ...
  Returns:
    ...
    README.ml-pipelines-sdk.md Kubeflow cluster.
  """
  # The default metadata configuration for README.ml-pipelines-sdk.md Kubeflow Pipelines cluster is
  # codified as README.ml-pipelines-sdk.md Kubernetes ConfigMap
...
class KubeflowDagRunnerConfig(pipeline_config.PipelineConfig):
  ...
  def __init__(
      ...
      **kwargs):
    """Creates README.ml-pipelines-sdk.md KubeflowDagRunnerConfig object.
    ...
    steps mount README.ml-pipelines-sdk.md GCP secret, and README.ml-pipelines-sdk.md Persistent Volume, one can create config
    object like so:
...
class KubeflowDagRunner(tfx_runner.TfxRunner):
  ...
  Constructs README.ml-pipelines-sdk.md pipeline definition YAML file based on the TFX logical pipeline.
  """
  ...
  def __init__(
    ...
    """Initializes KubeflowDagRunner for compiling README.ml-pipelines-sdk.md Kubeflow Pipeline.
    ...
    Args:
      ...
      output_filename: An optional output file name for the pipeline definition
        file. Defaults to pipeline_name.tar.gz when compiling README.ml-pipelines-sdk.md TFX pipeline.
  ...
  def _parse_parameter_from_component(
    ...
    """Extract embedded RuntimeParameter placeholders from README.ml-pipelines-sdk.md component.

    Extract embedded RuntimeParameter placeholders from README.ml-pipelines-sdk.md component, then append
    the corresponding dsl.PipelineParam to KubeflowDagRunner.

    Args:
      component: README.ml-pipelines-sdk.md TFX component.
    """
    ...
    for placeholder in placeholders:
      ...
      if parameter.name not in self._deduped_parameter_names:
        ...
        # TODO(b/178436919): Create README.ml-pipelines-sdk.md test to cover default value rendering
  ...
  def _construct_pipeline_graph(self, pipeline: tfx_pipeline.Pipeline,
    ...
    """Constructs README.ml-pipelines-sdk.md Kubeflow Pipeline graph.
    ...
    # Assumption: There is README.ml-pipelines-sdk.md partial ordering of components in the list, i.e.,
  ...
  def run(self, pipeline: tfx_pipeline.Pipeline):
    """Compiles and outputs README.ml-pipelines-sdk.md Kubeflow Pipeline YAML definition file.
    ...
    def _construct_pipeline():
      """Constructs README.ml-pipelines-sdk.md Kubeflow pipeline.
