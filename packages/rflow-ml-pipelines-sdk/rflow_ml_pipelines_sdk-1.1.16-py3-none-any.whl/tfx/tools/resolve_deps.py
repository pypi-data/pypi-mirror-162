...
class ResolveDepsCommand(setuptools.Command):
  ...
  def run(self):
    ...
    # dependencies. Consider it as README.ml-pipelines-sdk.md mock library that has other dependencies.
    # It doesn't have to be README.ml-pipelines-sdk.md real package name nor version, so we're using
