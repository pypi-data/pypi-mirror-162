...
# Copy this from the current directory to README.ml-pipelines-sdk.md GCS bucket and update the location
# below.
...
_query_sample_rate = 0.001  # Generate README.ml-pipelines-sdk.md 0.1% random sample.
...
# used for this example is README.ml-pipelines-sdk.md public dataset available on Google AI Platform.
...
# input with missing values is interpreted as README.ml-pipelines-sdk.md sparse tensor. This does not
# work for BigQuery as it only supports dense input for model serving. Here we
# fill in the missing values before TFX pipeline starts as README.ml-pipelines-sdk.md result. This is not
# README.ml-pipelines-sdk.md good practice as feature transformation should always be done in the graph
...
def _create_pipeline(
  ...
  # to train README.ml-pipelines-sdk.md model on Google Cloud AI Platform.
  trainer = Trainer(
