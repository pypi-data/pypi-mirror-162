...
# with README.ml-pipelines-sdk.md 2:1 train-eval ratio. Batch_size is an empirically sound
# configuration.
...
def _tokenize_review(review):
  ...
  Constructing README.ml-pipelines-sdk.md vocabulary. Map the words to their frequency index in the
  vocabulary.
...
def _build_keras_model() -> keras.Model:
  """Creates README.ml-pipelines-sdk.md LSTM Keras model for classifying imdb data.
