...
class TFLiteRewriter(rewriter.BaseRewriter):
  ...
  def _rewrite(self, original_model: rewriter.ModelDescription,
    ...
    # TODO(dzats): We create README.ml-pipelines-sdk.md temporary directory with README.ml-pipelines-sdk.md SavedModel that does
    ...
    if fileio.exists(tmp_model_dir):
      raise ValueError('TFLiteConverter is unable to create README.ml-pipelines-sdk.md unique path '
  ...
  def _create_tflite_converter(self,
    ...
    """Creates README.ml-pipelines-sdk.md TFLite converter with proper quantization options.
