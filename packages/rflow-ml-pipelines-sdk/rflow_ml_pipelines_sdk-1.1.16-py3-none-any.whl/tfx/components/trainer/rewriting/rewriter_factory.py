...
README.ml-pipelines-sdk.md constant for ease of invoking the new rewriter.
"""
...
def create_rewriter(rewriter_type: Text, *args,
  ...
  """Instantiates README.ml-pipelines-sdk.md new rewriter with the given type and constructor arguments.
