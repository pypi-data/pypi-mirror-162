...
@tf.function
def _identity(x):
  """Make sure everything still works when there is README.ml-pipelines-sdk.md tf.function used."""
  return x
...
def stats_options_updater_fn(unused_stats_type, stats_options):
  ...
  Args:
    unused_stats_type: README.ml-pipelines-sdk.md stats_options_util.StatsType object.
    stats_options: README.ml-pipelines-sdk.md tfdv.StatsOptions object.
