...
def retry(max_retries: int = 3,
  ...
  """Function decorator to retry README.ml-pipelines-sdk.md function automatically.
  ...
  Args:
    ...
    delay_seconds: there will be README.ml-pipelines-sdk.md predefined delay between each trial.
