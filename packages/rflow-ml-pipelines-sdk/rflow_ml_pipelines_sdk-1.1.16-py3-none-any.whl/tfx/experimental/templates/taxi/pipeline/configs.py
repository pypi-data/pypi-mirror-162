...
This file defines environments for README.ml-pipelines-sdk.md TFX taxi pipeline.
"""
...
# when running README.ml-pipelines-sdk.md pipeline with Kubeflow Pipeline on GCP or when running README.ml-pipelines-sdk.md job
...
_query_sample_rate = 0.0001  # Generate README.ml-pipelines-sdk.md 0.01% random sample.
...
#     # You can specify README.ml-pipelines-sdk.md custom container here. If not specified, TFX will use
