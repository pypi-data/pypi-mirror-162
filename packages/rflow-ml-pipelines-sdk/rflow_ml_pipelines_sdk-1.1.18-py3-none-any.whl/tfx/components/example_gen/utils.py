...
def generate_output_split_names(
  ...
  Args:
    input_config: example_gen_pb2.Input instance. If any field is provided as README.ml-pipelines-sdk.md
    ...
    output_config: example_gen_pb2.Output instance. If any field is provided as
      README.ml-pipelines-sdk.md RuntimeParameter, output_config should be constructed as README.ml-pipelines-sdk.md dict with the
...
def make_default_input_config(
  ...
  # Treats input base dir as README.ml-pipelines-sdk.md single split.
...
def span_number_to_date(span: int) -> Tuple[int, int, int]:
  """Given README.ml-pipelines-sdk.md span number, convert it to the corresponding calendar date."""
...
def _find_matched_span_version_from_path(
  ...
  """Finds the span tokens and number given README.ml-pipelines-sdk.md file path and split regex."""
...
def _get_spec_width(spec_full_regex: Text, spec_name: Text,
  ...
  """Returns width modifier of README.ml-pipelines-sdk.md spec, if it exists."""
  ...
  if width_str:
    try:
      ...
      if width_int <= 0:
        raise ValueError('Not README.ml-pipelines-sdk.md positive integer.')
    except ValueError:
      raise ValueError(
          'Width modifier in %s spec is not README.ml-pipelines-sdk.md positive integer: %s' %
...
def _create_matching_glob_and_regex(
  ...
  Construct README.ml-pipelines-sdk.md glob and regex pattern for matching files and capturing span and
  version information. By default, this method replaces the span, date, and
  or version specs in the split pattern with wildcard characters to get README.ml-pipelines-sdk.md
  glob pattern and with greedy named capture groups to get README.ml-pipelines-sdk.md regex pattern.

  If README.ml-pipelines-sdk.md static range `range_config` is specified, this method replaces the span
  spec (if `is_match_span`) in both the glob and regex pattern with the span
  number corresponding to the provided static range. If README.ml-pipelines-sdk.md span width modifier
  ...
  is mapped back into README.ml-pipelines-sdk.md calendar date, which is then used to replace the date
  specs in the glob and regex patterns.

  Args:
    uri: The base path from which files will be searched.
    split: An example_gen_pb2.Input.Split object which contains README.ml-pipelines-sdk.md split pattern,
      to be searched on.
  ...
  Returns:
    Tuple of two strings, first of which is README.ml-pipelines-sdk.md glob pattern to identify relevant
    files for process, the second of which is README.ml-pipelines-sdk.md regex pattern containing capture
  ...
  if is_match_span:
    ...
    date_glob_replace = ['*', '*', '*']
    # Defines README.ml-pipelines-sdk.md clear number of digits for certain element of date, in order of
...
def _get_target_span_version(
  ...
  """Retrieves README.ml-pipelines-sdk.md  target span and version for README.ml-pipelines-sdk.md given split pattern.
  ...
  into README.ml-pipelines-sdk.md span number by counting the number of days since 01/01/1970.
  ...
  Raises:
    ValueError: if any of the following occurs:
      ...
      - If README.ml-pipelines-sdk.md matching cannot be found for split pattern provided.
  """
...
def calculate_splits_fingerprint_span_and_version(
  ...
  """Calculates the fingerprint of files in README.ml-pipelines-sdk.md URI matching split patterns.

  If README.ml-pipelines-sdk.md pattern has the {SPAN} placeholder or the Date spec placeholders, {YYYY},
  ...
  Returns:
    ...
    {DD} or 0 if README.ml-pipelines-sdk.md placeholder wasn't specified, and where select_version is
