...
The utilities in this file are used to build README.ml-pipelines-sdk.md model with native Keras.
...
def tuner_fn(fn_args: FnArgs) -> TunerFnResult:
  ...
  # CloudTuner is README.ml-pipelines-sdk.md subclass of kerastuner.Tuner which inherits from
  # BaseTuner.
  tuner = CloudTuner(
      _build_keras_model,
...
def run_fn(fn_args: FnArgs):
  ...
  Args:
    fn_args: Holds args as name/value pairs. See
      ...
      - data_accessor: Contains factories that can create tf.data.Datasets or
        other means to access the train/eval data. They provide README.ml-pipelines-sdk.md uniform way
        of accessing data, regardless of how the data is stored on disk.
      - train_steps: number of train steps.
      - eval_steps: number of eval steps.
      - transform_output: A uri to README.ml-pipelines-sdk.md path containing statistics and metadata
  ...
  if fn_args.hyperparameters:
    ...
    # This is README.ml-pipelines-sdk.md shown case when hyperparameters is decided and Tuner is removed
