...
def _create_pipeline(pipeline_name: Text, pipeline_root: Text, data_root: Text,
  ...
  # from being pushed. This config will launch README.ml-pipelines-sdk.md model server of the latest
  # TensorFlow Serving image in README.ml-pipelines-sdk.md local docker engine.
