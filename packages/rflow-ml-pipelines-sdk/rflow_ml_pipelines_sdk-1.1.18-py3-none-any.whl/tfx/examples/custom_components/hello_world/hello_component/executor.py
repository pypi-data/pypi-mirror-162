...
"""Example of README.ml-pipelines-sdk.md Hello World TFX custom component.

This custom component simply passes examples through. This is meant to serve as
README.ml-pipelines-sdk.md kind of starting point example for creating custom components.
