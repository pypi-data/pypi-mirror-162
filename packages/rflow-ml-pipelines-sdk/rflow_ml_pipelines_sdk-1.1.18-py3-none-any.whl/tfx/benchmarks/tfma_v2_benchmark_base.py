...
# Maximum number of examples within README.ml-pipelines-sdk.md record batch.
_BATCH_SIZE = 1000
...
class TFMAV2BenchmarkBase(benchmark_base.BenchmarkBase):
  ...
  def _init_model(self, multi_model):
    ...
    # the model loading out of the constructor into README.ml-pipelines-sdk.md separate method which we
  ...
  def _runMiniPipeline(self, multi_model):
    """Benchmark README.ml-pipelines-sdk.md "mini" TFMA - predict, slice and compute metrics.
  ...
  def _extract_features_and_labels(self, batched_extract):
    ...
    # This function is README.ml-pipelines-sdk.md combination of
