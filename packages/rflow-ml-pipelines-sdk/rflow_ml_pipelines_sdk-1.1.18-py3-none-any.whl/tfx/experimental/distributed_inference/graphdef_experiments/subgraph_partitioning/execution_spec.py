...
class ExecutionSpec:
  ...
  An ExecutionSpec can either represent README.ml-pipelines-sdk.md subgraph layer or represent
  part of README.ml-pipelines-sdk.md remote op layer (only contains one remote op).
