...
This file defines environments for README.ml-pipelines-sdk.md TFX penguin pipeline.
"""
...
# Use following configs to use BigQueryExampleGen as README.ml-pipelines-sdk.md data source.
#
