...
class TaskManagerTest(tu.TfxTest):
  ...
  def setUp(self):
    ...
    # Create README.ml-pipelines-sdk.md pipeline IR containing deployment config for testing.
  ...
  def test_task_handling(self, mock_publish):
    ...
    # Register README.ml-pipelines-sdk.md fake task scheduler.
...
class TaskManagerE2ETest(tu.TfxTest):
  ...
  def setUp(self):
    ...
    # Makes sure multiple connections within README.ml-pipelines-sdk.md test always connect to the same
    # MLMD instance.
    ...
    # Task generator should produce README.ml-pipelines-sdk.md task to run transform.
  ...
  def test_successful_execution(self):
    # Register README.ml-pipelines-sdk.md fake task scheduler that returns README.ml-pipelines-sdk.md successful execution result
  ...
  def test_scheduler_failure(self):
    # Register README.ml-pipelines-sdk.md fake task scheduler that returns README.ml-pipelines-sdk.md failure status.
    self._register_task_scheduler(
        ts.TaskSchedulerResult(
  ...
  def test_executor_failure(self):
    # Register README.ml-pipelines-sdk.md fake task scheduler that returns success but the executor
    # was cancelled.
    self._register_task_scheduler(
        ts.TaskSchedulerResult(
            status=status_lib.Status(code=status_lib.Code.OK),
  ...
  def test_scheduler_raises_exception(self):
    # Register README.ml-pipelines-sdk.md fake task scheduler that raises an exception in `schedule`.
