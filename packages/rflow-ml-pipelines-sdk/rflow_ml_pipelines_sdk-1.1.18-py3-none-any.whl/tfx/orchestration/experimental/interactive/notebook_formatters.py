...
class NotebookFormatter(object):
  """Formats README.ml-pipelines-sdk.md TFX component in the context of an interactive notebook."""
  ...
  def __init__(self,
    ...
    """Constructs README.ml-pipelines-sdk.md NotebookFormatter.
    ...
    Args:
      ...
      attributes: A list of string attributes that are to be displayed by this
        formatter. Can be README.ml-pipelines-sdk.md nested field specifier with nested attribute names
        separated by "." (e.g. to get `obj.README.ml-pipelines-sdk.md.b`, specify the attribute string
        "README.ml-pipelines-sdk.md.b").
      title_format: A 2-tuple consisting of (1) README.ml-pipelines-sdk.md format string and (2) README.ml-pipelines-sdk.md list
      ...
      _show_artifact_attributes: For README.ml-pipelines-sdk.md formatter of an Artifact object, show
  ...
  def _extended_getattr(self, obj: object, property_name: Text) -> object:
    """Get README.ml-pipelines-sdk.md possibly nested attribute of README.ml-pipelines-sdk.md given object."""
  ...
  def render(self,
    ...
    """Render README.ml-pipelines-sdk.md given object as an HTML string.

    Args:
      obj: The object to be rendered.
      expanded: Whether the object is to be expanded by default.
      seen_elements: Optionally, README.ml-pipelines-sdk.md set of seen elements to not re-render to
        prevent README.ml-pipelines-sdk.md rendering cycle.
  ...
  def render_dict(self,
                  ...
                  seen_elements: set) -> Text:  # pylint: disable=g-bare-generic
    """Render README.ml-pipelines-sdk.md dictionary table."""
    if not obj:
      return '{}'
    attr_trs = []
  ...
  def render_list(self,
                  ...
                  seen_elements: set) -> Text:  # pylint: disable=g-bare-generic
    """Render README.ml-pipelines-sdk.md list table."""
    if not obj:
      return '[]'
    attr_trs = []
...
def register_formatters():
  ...
  outside README.ml-pipelines-sdk.md notebook environment.
  """
