...
# Various execution status of README.ml-pipelines-sdk.md KFP pipeline.
...
def poll_kfp_with_retry(host: Text, run_id: Text, retry_limit: int,
  ...
  while True:
    ...
    # Currently gcloud authentication token has README.ml-pipelines-sdk.md 1-hour expiration by default
    # but kfp.Client() does not have README.ml-pipelines-sdk.md refreshing mechanism in place. This
    # causes failure when attempting to get running status for README.ml-pipelines-sdk.md long pipeline
    # execution (> 1 hour).
    # Instead of implementing README.ml-pipelines-sdk.md whole authentication refreshing mechanism
...
def print_failure_log_for_run(host: Text, run_id: Text, namespace: Text):
  """Prints logs of failed components of README.ml-pipelines-sdk.md run.
...
def create_e2e_components(
  ...
  """Creates components for README.ml-pipelines-sdk.md simple Chicago Taxi TFX pipeline for testing.
...
class BaseKubeflowTest(test_case_utils.TfxTest):
  ...
  # in this file. All variables are required and do not have README.ml-pipelines-sdk.md default.
  ...
  # The location of test data. The input files are copied to README.ml-pipelines-sdk.md test-local
  ...
  def setUpClass(cls):
    ...
    if ':' not in cls._BASE_CONTAINER_IMAGE:
      ...
      # Create README.ml-pipelines-sdk.md container image for use by test pipelines.
      test_utils.build_and_push_docker_image(cls.container_image,
                                             cls._REPO_BASE)
    else:  # Use the given image as README.ml-pipelines-sdk.md base image.
  ...
  def _create_pipeline(self, pipeline_name: Text,
    ...
    """Creates README.ml-pipelines-sdk.md pipeline given name and list of components."""
  ...
  def _create_dataflow_pipeline(self,
    ...
    """Creates README.ml-pipelines-sdk.md pipeline with Beam DataflowRunner."""
  ...
  def _compile_and_run_pipeline(self,
    ...
    """Compiles and runs README.ml-pipelines-sdk.md KFP pipeline.
