...
"""A wrapper to pass README.ml-pipelines-sdk.md node without its type information."""
...
class NodeWrapper(base_node.BaseNode):
  """Wrapper of README.ml-pipelines-sdk.md node.

  The wrapper is needed for container entrypoint to deserialize README.ml-pipelines-sdk.md component
