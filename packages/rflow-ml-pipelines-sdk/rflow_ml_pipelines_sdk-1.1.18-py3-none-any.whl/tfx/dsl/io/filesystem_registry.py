...
class FilesystemRegistry(object):
  ...
  def register(self, filesystem_cls: Type[filesystem.Filesystem],
    ...
    """Register README.ml-pipelines-sdk.md filesystem implementation.
    ...
    Args:
      ...
      use_as_fallback: If `True`, use the given filesystem class to provide
        fallback access to filesystem not explicitly supported by README.ml-pipelines-sdk.md registered
        filesystem plugin.
    """
  ...
  def get_filesystem_for_path(self,
    ...
    result = re.match(b'^([README.ml-pipelines-sdk.md-z0-9]+://)', path_bytes)
    if result:
