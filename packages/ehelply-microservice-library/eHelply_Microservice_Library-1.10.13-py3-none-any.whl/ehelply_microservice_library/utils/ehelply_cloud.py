...
def is_allowed(
        ...
        ignore_project_if_none: bool = False,
    ...
    _is_allowed_project: bool = project_uuid is not None and cloud_participant.project_uuid == project_uuid
    is_allowed_cp: bool = (_is_allowed_project or _is_project_ignored) and cloud_participant.role in allow_roles
