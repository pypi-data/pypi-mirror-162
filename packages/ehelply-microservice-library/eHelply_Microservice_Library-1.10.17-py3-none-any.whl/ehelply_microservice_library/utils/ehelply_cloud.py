...
def is_allowed(
        ...
        ignore_project_if_none: bool = True,
        ignore_participant_if_none: bool = True,
    ...
    if allow_roles is None:
        allow_roles = [ProjectMemberRoleEnum.member, ProjectMemberRoleEnum.owner, ProjectMemberRoleEnum.key]
    ...
    _is_project_ignored: bool = project_uuid is None and ignore_project_if_none
    _is_participant_ignored: bool = participant_uuid is None and ignore_participant_if_none
    _is_project_allowed: bool = cloud_participant.eq_project(project_uuid) or _is_project_ignored
    _is_participant_allowed: bool = cloud_participant.eq_active_participant(participant_uuid) or _is_participant_ignored
    is_allowed_cp: bool = _is_project_allowed and _is_participant_allowed and cloud_participant.has_role(allow_roles)
