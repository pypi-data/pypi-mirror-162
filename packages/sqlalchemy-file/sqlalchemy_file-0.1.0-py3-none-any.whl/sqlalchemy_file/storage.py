...
class StorageManager:
    ...
    Use :meth:`add_storage` to add new :class:`libcloud.storage.base.Container`
    and associate a name which will be use later to retrieve this container.

    The first container will be used as default, to simplify code when you have
    only one container.

    Use associated name as upload_storage for :class:`FileField` to store all
    files of this Column into the associated container.
