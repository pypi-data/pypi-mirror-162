...
from .utils import fix_lims_path, is_windows
...
def _resolve_query(exp_id: Optional[str], wkft: Optional[str]) -> Query:
    if wkft and exp_id:
...
def find_files(
    ...
    query = _resolve_query(exp_id=exp_id, wkft=wkft)
