...
def HiCAT( X_cell_by_gene, marker_file, log_transformed = False,
    ...
    res = MarkerCount_GSA( X_cell_by_gene, marker_file, log_transformed,
                   ...
                   use_markers_for_pca, comb_mkrs, copy_X, verbose )
    return res
...
def plot_dot_s(adata, target_lst, type_level, mkr_file, title = None, rend = None, level = 1, 
              cutoff = 0, PNSH12 = '100000', rem_cmn = False, dot_max = 0.5, swap_ax = False,
              to_exclude = [], Npt = 10, figsize = (20, 4), ax = None):
    ...
    with warnings.catch_warnings():
        ...
        dp = sc.pl.dotplot(adata_t, mkrs_dict, groupby = type_level, figsize = (nw*0.36, nh*0.3),
                           categories_order = list(mkrs_dict.keys()), ax = ax,
                           log = True, var_group_rotation = 10, show = False, 
                           standard_scale = 'var', dot_max = dot_max, swap_axes = swap_ax ) 
