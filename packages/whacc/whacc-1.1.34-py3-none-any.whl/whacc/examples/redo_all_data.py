...
for ii, (i1, i2) in enumerate(utils.loop_segments(full_test_fn)):
    i3 = (i2-i1)/2
...
utils.overwrite_h5_key(h5_file_name, 'in_range_by_hand', in_range_by_hand)
...
in_range_by_hand = image_tools.get_h5_key_and_concatenate(h5_file_name, 'in_range_by_hand')
