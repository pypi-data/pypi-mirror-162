...
class AuditBaseOperator(BaseOperator):
    ...
    def __init__(
        ...
        logger.info('logger.info - Audit SQL --->'+self.aud_sql)
        logger.info('logger.info - Final SQL --->'+self.sql)

        logging.info('logging.info - Audit SQL --->'+self.aud_sql)
        logging.info('logging.info - Final SQL --->'+self.sql)                
