...
def get_allocation_stats():
    nxjv__dgjxc = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    ruvx__ovi, gxe__dlrsq, qqd__igf, lxvin__qyuma = 0, 0, 0, 0
    for jjx__ghz in nxjv__dgjxc:
        ruvx__ovi += jjx__ghz[0]
        gxe__dlrsq += jjx__ghz[1]
        qqd__igf += jjx__ghz[2]
        lxvin__qyuma += jjx__ghz[3]
    return ruvx__ovi, gxe__dlrsq, qqd__igf, lxvin__qyuma
