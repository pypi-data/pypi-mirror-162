...
def get_allocation_stats():
    yehe__xzb = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    nggd__owp, xmd__qjv, pab__ynbq, yhk__yas = 0, 0, 0, 0
    for yod__ogynm in yehe__xzb:
        nggd__owp += yod__ogynm[0]
        xmd__qjv += yod__ogynm[1]
        pab__ynbq += yod__ogynm[2]
        yhk__yas += yod__ogynm[3]
    return nggd__owp, xmd__qjv, pab__ynbq, yhk__yas
