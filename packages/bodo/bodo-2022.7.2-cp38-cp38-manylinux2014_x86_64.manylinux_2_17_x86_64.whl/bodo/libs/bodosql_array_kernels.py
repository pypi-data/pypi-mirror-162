...
broadcasted_fixed_arg_functions = {'bitand', 'bitleftshift', 'bitnot',
    'bitor', 'bitrightshift', 'bitxor', 'booland', 'boolnot', 'boolor',
    'boolxor', 'char', 'cond', 'conv', 'day_timestamp', 'dayname', 'div0',
    'editdistance_no_max', 'editdistance_with_max', 'equal_null', 'format',
    'getbit', 'haversine', 'instr', 'int_to_days', 'last_day', 'left',
    'log', 'lpad', 'makedate', 'month_diff', 'monthname', 'negate',
    'nullif', 'ord_ascii', 'regr_valx', 'regr_valy', 'repeat', 'replace',
    'reverse', 'right', 'rpad', 'second_timestamp', 'space', 'strcmp',
    'substring', 'substring_index', 'weekday', 'year_timestamp',
    'yearofweekiso'}
