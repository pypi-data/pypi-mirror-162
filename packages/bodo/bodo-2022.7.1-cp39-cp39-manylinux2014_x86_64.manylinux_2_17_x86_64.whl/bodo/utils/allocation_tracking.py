...
def get_allocation_stats():
    jcjm__mrtsd = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    kyg__ksrn, vaqd__gurq, gdttr__llac, judre__hrw = 0, 0, 0, 0
    for yuj__omskc in jcjm__mrtsd:
        kyg__ksrn += yuj__omskc[0]
        vaqd__gurq += yuj__omskc[1]
        gdttr__llac += yuj__omskc[2]
        judre__hrw += yuj__omskc[3]
    return kyg__ksrn, vaqd__gurq, gdttr__llac, judre__hrw
