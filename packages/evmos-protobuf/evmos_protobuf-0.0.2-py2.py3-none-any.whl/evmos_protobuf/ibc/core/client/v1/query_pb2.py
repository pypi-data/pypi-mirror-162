...
QueryConsensusStateHeightsRequest = _reflection.GeneratedProtocolMessageType('QueryConsensusStateHeightsRequest', (_message.Message,), {'DESCRIPTOR': _QUERYCONSENSUSSTATEHEIGHTSREQUEST, '__module__': 'ibc.core.client.v1.query_pb2'})
_sym_db.RegisterMessage(QueryConsensusStateHeightsRequest)
QueryConsensusStateHeightsResponse = _reflection.GeneratedProtocolMessageType('QueryConsensusStateHeightsResponse', (_message.Message,), {'DESCRIPTOR': _QUERYCONSENSUSSTATEHEIGHTSRESPONSE, '__module__': 'ibc.core.client.v1.query_pb2'})
