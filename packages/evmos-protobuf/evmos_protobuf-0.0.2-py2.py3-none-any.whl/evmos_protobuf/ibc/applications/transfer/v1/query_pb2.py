...
QueryEscrowAddressRequest = _reflection.GeneratedProtocolMessageType('QueryEscrowAddressRequest', (_message.Message,), {'DESCRIPTOR': _QUERYESCROWADDRESSREQUEST, '__module__': 'ibc.applications.transfer.v1.query_pb2'})
_sym_db.RegisterMessage(QueryEscrowAddressRequest)
QueryEscrowAddressResponse = _reflection.GeneratedProtocolMessageType('QueryEscrowAddressResponse', (_message.Message,), {'DESCRIPTOR': _QUERYESCROWADDRESSRESPONSE, '__module__': 'ibc.applications.transfer.v1.query_pb2'})
