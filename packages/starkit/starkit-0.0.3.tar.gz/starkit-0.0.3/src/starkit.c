...
static PyObject* alpha_calculation(PyObject *self, PyObject *args){
	...
	double temp21, temp31;
	double alpha911 = 0, alpha921 = 0;
	...
	{		
		...
		if (temp1 >= 0)//if temp1>=0 :
		{
			...
			if (((fabs(temp2)) <= 1) && ((fabs(temp3) <= 1)))//if math.fabs(temp2) <= 1 and math.fabs(temp3) <= 1:
			{
				...
				if (fabs(temp21) <= 1)//if math.fabs(temp21) <= 1:
				{
					alpha911 = acos(temp21);//alpha911 = math.acos(temp21)	
					if ((alpha91 > 0 && alpha911 > alpha91) || (alpha91 < 0 && alpha911 < alpha91))//:if (alpha91 > 0 and alpha911 > alpha91) or (alpha91 < 0 and alpha911 < alpha91):
					alpha91 = alpha911; //alpha91 = alpha911
				}
				if (fabs(temp31) <= 1)//if math.fabs(temp31) <= 1:
				{
					alpha921 = acos(temp31);//alpha921 = math.acos(temp31)	
					if ((alpha92 > 0 && alpha921 > alpha92) || (alpha92 < 0 && alpha921 < alpha92))//://if (alpha92 > 0 and alpha921 > alpha92) or (alpha92 < 0 and alpha921 < alpha92):
					alpha92 = alpha921; //alpha92 = alpha921
				}
				//Ver4 change stop
			}
			else 
		...
		//Ver4 change start
		//alpha81 = math.atan(-(K1+a8*math.sin(alpha91))/(-(K2+a8*math.cos(alpha91)))) - alpha91
		alpha81	= atan2(-(K1 + a8 * sin(alpha91)) , (-(K2 + a8 * cos(alpha91)))) - alpha91;
        //alpha82 = math.atan(-(K1+a8*math.sin(alpha92))/(-(K2+a8*math.cos(alpha92)))) - alpha92
		alpha82	= atan2(-(K1 + a8 * sin(alpha92)) , (-(K2 + a8 * cos(alpha92)))) - alpha92;
		//Ver4 change stop		
