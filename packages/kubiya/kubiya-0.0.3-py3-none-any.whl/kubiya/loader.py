...
def load_actions_store_file(file_path: str) -> str:
    ...
    try:
        ...
        filename = file.name
        # print(f"Loading actions_store {filename} from {parents}")
...
def load_actions_store(store_name: str) -> str:
    try:
        return load_actions_store_file(store_name)
    except Exception as e:
