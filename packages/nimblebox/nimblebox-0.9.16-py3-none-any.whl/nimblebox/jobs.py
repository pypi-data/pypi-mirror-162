...
from nimblebox.messages import rpc, streaming_rpc
from nimblebox.hyperloop.nbox_ws_pb2 import JobInfo
from nimblebox.init import nbox_grpc_stub, nbox_ws_v1

from nimblebox.hyperloop.job_pb2 import NBXAuthInfo, Job as JobProto
from nimblebox.hyperloop.nbox_ws_pb2 import ListJobsRequest, JobLogsRequest, ListJobsResponse, UpdateJobRequest
...
def upload_job_folder(method: str, init_folder: str, id_or_name: str, workspace_id: str = None):
  ...
  from nimblebox import Operator
  from nimblebox.network import deploy_job, deploy_serving
