...
from nimblebox.subway import TIMEOUT_CALLS
from nimblebox.init import nbox_ws_v1, create_webserver_subway
...
class Instance():
  ...
  def __create_connection(self, *, port: int = 6174):
    ...
    from nimblebox.sub_utils.ssh import FileLogger, ConnectionManager
