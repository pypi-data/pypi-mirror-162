...
class CustomerComplaints(BaseAbcp):
    ...
    async def update(self, id: int, number: int = None, expert_id: Union[int, str] = None,
        ...
        :param custom_complaint_file: [необязательный] - форма "Заявка на возврат", файл, передавать строкой в формате base64. Для удаления файла - указать пустую строку.
