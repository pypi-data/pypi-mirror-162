...
class CompassRun:
    ...
    def add_trans(
        ...
        counts_in = counts_in_raw - bg_val * self.t_meas * ((t_hi - t_lo) / n_bins)
        counts_out_raw, __ = np.histogram(target_out, bins=n_bins, range=[t_lo, t_hi])
        counts_out = counts_out_raw - bg_val * self.t_meas * ((t_hi - t_lo) / n_bins)
    ...
    def write_trans(self, fname="trans.txt", mode="w"):
        ...
        with open(fname, mode) as f:
            ...
            f.write("     5 0.0000E+00  0.0000E+00  0.0000E+00  0.0000E+00  0.0000E+00\n")
