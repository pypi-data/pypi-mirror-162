...
class PulsarQrm(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.7.2 fwBuild=28/07/2022-16:05:59 fwHash=0xB5C9673B fwDirty=0 kmodVersion=0.7.2 kmodBuild=28/07/2022-16:05:59 kmodHash=0xB5C9673B kmodDirty=0 swVersion=0.7.2 swBuild=28/07/2022-16:05:59 swHash=0xB5C9673B swDirty=0 cfgManVersion=0.2.0 cfgManBuild=28/07/2022-16:05:59 cfgManHash=0xB5C9673B cfgManDirty=0"
            if build != build_ref:
