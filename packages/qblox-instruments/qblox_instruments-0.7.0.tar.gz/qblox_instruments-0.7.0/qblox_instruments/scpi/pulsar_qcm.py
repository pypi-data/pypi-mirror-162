...
class PulsarQcm(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.7.2 fwBuild=28/07/2022-16:06:31 fwHash=0xAE241402 fwDirty=0 kmodVersion=0.7.2 kmodBuild=28/07/2022-16:06:31 kmodHash=0xAE241402 kmodDirty=0 swVersion=0.7.2 swBuild=28/07/2022-16:06:31 swHash=0xAE241402 swDirty=0 cfgManVersion=0.2.0 cfgManBuild=28/07/2022-16:06:31 cfgManHash=0xAE241402 cfgManDirty=0"
            if build != build_ref:
