...
@versioning.register(version="2", changelog="update data types")
@check_types
def resample(
    data: pd.Series,
...
@versioning.register(version="2", changelog="Describe here how the function changed compared to the previous version")
@check_types
