...
def remove(series: pd.Series, to_remove: Optional[List[float]] = None):
    ...
    Remove values in a time series. The values to remove should be a
    semicolon-separated list. Undefined and infinity values can be replaced by
    using nan, inf and -inf (e.g. 1.0, 5, inf, -inf, 20, nan).
