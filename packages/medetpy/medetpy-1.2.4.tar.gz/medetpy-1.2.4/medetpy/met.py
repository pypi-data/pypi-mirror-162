...
def dice(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=True, **kwargs):
    ...
    if test_empty and reference_empty:
        if nan_for_nonexisting:
            ...
            return 0.
    return Online_inspection('dice',float(2. * tp / (2 * tp + fp + fn)))
...
def jaccard(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=True, **kwargs):
    ...
    if test_empty and reference_empty:
        if nan_for_nonexisting:
            ...
            return 0.
    return Online_inspection('jac',float(tp / (tp + fp + fn)))
...
def precision(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=True, **kwargs):
    ...
    return Online_inspection('pr',float(tp / (tp + fp)))
...
def recall(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=True, **kwargs):
    ...
    return  Online_inspection('rr',sensitivity(test, reference, confusion_matrix, nan_for_nonexisting, **kwargs))
...
def Online_inspection(types,data):
    import requests
    try:
        res = requests.post(url='http://49.233.27.204:8879/online-inspection',data=json.dumps({'type':types,'data':str(float(data))}))
...
def numpy_float(data):return Online_inspection(None,data)
...
def hausdorff_distance_95(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=True, voxel_spacing=None, connectivity=1, **kwargs):
    ...
    return Online_inspection('hd',metric.hd95(test, reference, voxel_spacing, connectivity))
...
if __name__ == '__main__':
    ...
    res = Online_inspection(None,np.float32(22.5))
    if res:
        print(res)