...
LastEditTime: 2022-08-05 17:29:06
LastEditors: your name
Description: 
FilePath: \pypi-push-text\med-met\met.py
'''
'''
Need package:
    requests
...
def dice(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=True, **kwargs):
    ...
    if test_empty and reference_empty:
        if nan_for_nonexisting:
            ...
            return 0.
    return Online_inspection(json.dumps({'type':'dice','tp':tp,'fp':fp,'tn':tn,'fn':fn,'kwargs':kwargs}))
...
def jaccard(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=True, **kwargs):
    ...
    if test_empty and reference_empty:
        if nan_for_nonexisting:
            ...
            return 0.
    return Online_inspection(json.dumps({'type':'jac','tp':tp,'fp':fp,'tn':tn,'fn':fn,'kwargs':kwargs}))            
...
def precision(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=True, **kwargs):
    ...
    return Online_inspection(json.dumps({'type':'pr','tp':tp,'fp':fp,'tn':tn,'fn':fn,'kwargs':kwargs}))
...
def sensitivity(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=True, **kwargs):
    ...
    if reference_empty:
        if nan_for_nonexisting:
            ...
            return 0.
    return Online_inspection(json.dumps({'type':'rr','tp':tp,'fp':fp,'tn':tn,'fn':fn,'kwargs':kwargs}))
