...
def load(tracker):
    ...
    output_stream_names = {
        'default': create_key_name(Type.STREAM.value, '1MINUTES'),
        'pageviews': create_key_name(Type.STREAM.value, '1MINUTES', '', '', '', Metric.PAGEVIEWS.value),
        'unique_devices': create_key_name(Type.STREAM.value, '1MINUTES', '', '', '', Metric.UNIQUE_DEVICES.value)
    }
