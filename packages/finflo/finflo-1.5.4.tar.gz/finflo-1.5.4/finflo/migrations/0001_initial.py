...
def create_initial_draft(apps, schema_editor):
    # We get the model from the versioned app registry;
    # if we directly import it, it'll be the wrong version
    states = apps.get_model("finflows.States")
    db_alias = schema_editor.connection.alias
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transitionmanager', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='finflows.transitionmanager')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workflowitems', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='WorkFlowEvents', to='finflows.workflowitems')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_state', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='action_from_state', to='finflows.states')),
                ('model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='finflows.flowmodel')),
                ...
                ('to_state', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='finflows.states')),
            ],
            options={
