...
class Generated_Forms(Consumer):
    ...
    class __Forms(Consumer):
        ...
        @returns.json
        @http_get("generated/forms/forms/machine/model/{model}")
        def get_form_by_model(self, model: str, include_assigned_fields: Query(type=bool) = None):
            """This call will get a form based on the criteria"""
    ...
    class __Results(Consumer):
        ...
        def list(form_type: Query(type=str) = None
        ):
