...
class InsightsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_context_insights_endpoint = _Endpoint(
            settings={
                'response_type': (GetContextInsightsOutput,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/get_context_insights',
                'operation_id': 'get_context_insights',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'app_name': 'query',
                    'user_name': 'query',
                    'get_context_insights_input': 'body',
                },
    ...
    def get_context_insights(
        ...
        **kwargs
        ...
        """Get contextual insight payloads for this user  # noqa: E501

        Generates a new batch of insights for the given context  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_context_insights(app_name, user_name, get_context_insights_input, async_req=True)
        >>> result = thread.get()

        Args:
            app_name (str): The name of the app this method will be acting in
            user_name (str): Name of the user this method is acting on
            get_context_insights_input (GetContextInsightsInput):
        ...
        kwargs['user_name'] = \
            user_name
        kwargs['get_context_insights_input'] = \
            get_context_insights_input
        return self.get_context_insights_endpoint.call_with_http_info(**kwargs)
