...
[boto3.RedshiftServerless 1.24.11](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/redshiftserverless.html#RedshiftServerless)
...
Generated by
[mypy-boto3-builder 7.11.4](https://github.com/youtype/mypy_boto3_builder).
...
`boto3.client("redshiftserverless")`.
