...
setuptools.setup(
    ...
    version="1.1.1", # add ddrrun-path-xe for long ddr execution commands at IOS command prompt
    ...
    python_requires='>=3.6',
    py_modules=['ddrrun-xr', 'ddrrun-xe', 'ddrrun-path-xe', 'genie_parsers', 'ddrclass', 'ddrparserlib'],
    )
