...
class SentenceResolveSuite(unittest.TestCase):
    ...
    def buildAndFit(self, annoToFit) -> PipelineModel:
        ...
        emb = BertSentenceEmbeddings.pretrained("sbiobert_base_cased_mli", "en", "clinical/models").setInputCols(
            "document").setOutputCol("emb")
    ...
    def test_pretrained_model(self):
        model = sparknlp_jsl.extensions.finance.chunk_classification.SentenceEntityResolverModel.load(
            self.pretrainedModelSavePath).setInputCols("emb").setOutputCol("test_result")
