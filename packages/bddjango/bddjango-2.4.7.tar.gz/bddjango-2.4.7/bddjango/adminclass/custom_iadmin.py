...
# ImportAdmin: adminclass.ImportAdmin = get_base_admin_dc_by_iadmin('ImportAdmin')
# CsvImportExportAdmin: adminclass.CsvImportExportAdmin = get_base_admin_dc_by_iadmin('CsvImportExportAdmin')
# ExcelImportExportAdmin: adminclass.ExcelImportExportAdmin = get_base_admin_dc_by_iadmin('ExcelImportExportAdmin')
# ForceRunActionsAdmin: adminclass.ForceRunActionsAdmin = get_base_admin_dc_by_iadmin('ForceRunActionsAdmin')
# ListDisplayAdmin: adminclass.ListDisplayAdmin = get_base_admin_dc_by_iadmin('ListDisplayAdmin')
# BaseAdmin: adminclass.BaseAdmin = get_base_admin_dc_by_iadmin('BaseAdmin')

# BaseAdmin
# BaseAdmin.changelist_view()
# print(1)
