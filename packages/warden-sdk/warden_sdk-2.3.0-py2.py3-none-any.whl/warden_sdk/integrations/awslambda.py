...
from warden_sdk.utils import (logger, TimeoutThread,AnnotatedValue,event_from_exception,capture_internal_exceptions,)
...
class AwsLambdaIntegration(Integration):
    ...
    def setup_once():
        ...
        if pre_37:
            ...
            def warden_handle_event_request(request_handler, *args, **kwargs): # type: ignore
