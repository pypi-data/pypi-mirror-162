...
from op.dbs import Db, fns, hook, last
from op.obj import Object, edit, get, items, keys, save, update, values
from op.obj import dumps, format, load, loads, register
...
class Test_Object(unittest.TestCase):
    ...
    def test_save(self):
        ...
        o = Object()
        p = save(o)
        self.assertTrue(os.path.exists(os.path.join(op.obj.workdir, "store", p)))
