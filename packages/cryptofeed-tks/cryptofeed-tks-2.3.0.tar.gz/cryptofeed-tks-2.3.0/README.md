# THE KARA SYSTEM: THIS IS AN INOFFICIAL PRE-RELEASE OF CRYPTOFEED

Caution - This library has changes, which are very likely to appear in the next version of cryptofeed - or not. Do not use this library and stick to the old one.
