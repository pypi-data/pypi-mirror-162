...
def play_game(
    ...
    simulation_logs_level: bool = typer.Argument(default=logging.WARNING,
                                                 help="Logs level for simulator logs", show_default=True)
) -> GameResult:
    """
    ...
    try:
        logger.info(
            f"Starting simulation of game for bot1: {player1_url}, bot2: {player2_url}")
